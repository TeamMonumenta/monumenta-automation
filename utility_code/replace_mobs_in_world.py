...
mobs_to_replace = [
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"{\"text\":\"Frost Moon Knight\"}",Health:35.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}],Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}],Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}],Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],Attributes:[{Base:35.0d,Name:"generic.maxHealth"}],Tags:["boss_iceaspect","boss_iceaspect"],HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§aPermafrost Spellblade\"}"},Enchantments:[{lvl:9s,id:"minecraft:sharpness"},{lvl:2s,id:"minecraft:unbreaking"}],Damage:0}},{id:"minecraft:shield",Count:1b,tag:{BlockEntityTag:{id:"minecraft:banner",Patterns:[{Pattern:"gra",Color:15},{Pattern:"gru",Color:3},{Pattern:"mc",Color:8},{Pattern:"tts",Color:0},{Pattern:"bts",Color:0},{Pattern:"bo",Color:0}],Base:15},Damage:0}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
