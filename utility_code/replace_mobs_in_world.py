...
mobs_to_replace = [
    ...
    # Region 1
    {
        'rules': {
            'id': 'minecraft:zombie',
            'CustomName': r'''§6Bandit Executioner'''
        },
        'mojangson': r'''{id:"minecraft:zombie",CustomName:"{\"text\":\"§6Bandit Executioner\"}",Health:35.0f,ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:8070172},AttributeModifiers:[{UUIDMost:-2628515879946596391L,UUIDLeast:-7800773419012928686L,Amount:0.1d,Slot:"feet",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]},Count:1b},{id:"minecraft:leather_leggings",tag:{display:{color:8070172}},Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{Lore:["$$$"],color:8070172}},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"f778d9a1-3995-4be4-8853-d2c788e94230",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTE4YjkyOTM4MWFiNWZiZWIwY2NiNzFkM2ZjYjhlMzk2MzJlMjUyZmI1NDQxNzFiYzBlNTc3YmMwYjFkIn19fQ=="}]}},display:{Name:"{\"text\":\"Bandit\"}"}},Count:1b}],Attributes:[{Base:36.0d,Name:"generic.maxHealth"}],Tags:["Elite"],HandItems:[{id:"minecraft:stone_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§fExecutioner\\u0027s Axe\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"}],AttributeModifiers:[{UUIDMost:-4279169696855735941L,UUIDLeast:-7856535437834413209L,Amount:7.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:shield",Count:1b,tag:{BlockEntityTag:{id:"minecraft:banner",Patterns:[{Pattern:"sku",Color:14}],Base:7}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': r'''§6Bandit Sniper'''
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"§6Bandit Sniper\"}",ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:8070172},AttributeModifiers:[{UUIDMost:-2628515879946596391L,UUIDLeast:-7800773419012928686L,Amount:0.1d,Slot:"feet",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]},Count:1b},{id:"minecraft:leather_leggings",tag:{display:{color:12423565}},Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{Lore:["$$$"],color:8070172}},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"f778d9a1-3995-4be4-8853-d2c788e94230",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTE4YjkyOTM4MWFiNWZiZWIwY2NiNzFkM2ZjYjhlMzk2MzJlMjUyZmI1NDQxNzFiYzBlNTc3YmMwYjFkIn19fQ=="}]}},display:{Name:"{\"text\":\"Bandit\"}"}},Count:1b}],Tags:["Elite"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:power"},{lvl:1s,id:"minecraft:punch"}]}},{id:"minecraft:shield",Count:1b,tag:{}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
    ...
    },
    {
        'rules': {
            ...
            'CustomName': r'''§6Pallid Slayer'''
        },
        'mojangson': r'''{id:"minecraft:vindicator",Passengers:[{Passengers:[{Passengers:[{Potion:{id:"minecraft:splash_potion",tag:{CustomPotionColor:5243008,CustomPotionEffects:[{Ambient:1b,ShowParticles:1b,Duration:400,Id:18b,Amplifier:0b}],Potion:"minecraft:empty"},Count:1b},id:"minecraft:potion"}],Potion:{id:"minecraft:splash_potion",tag:{CustomPotionColor:48127,CustomPotionEffects:[{Ambient:1b,ShowParticles:1b,Duration:400,Id:2b,Amplifier:1b}],Potion:"minecraft:empty"},Count:1b},id:"minecraft:potion"}],Potion:{id:"minecraft:splash_potion",tag:{Potion:"minecraft:strong_harming"},Count:1b},id:"minecraft:potion"}],CustomName:"{\"text\":\"§6Pallid Slayer\"}",Health:60.0f,Attributes:[{Base:80.0d,Name:"generic.maxHealth"},{Base:30.0d,Name:"generic.followRange"}],Tags:["Elite"],HandItems:[{id:"minecraft:iron_axe",tag:{Enchantments:[{lvl:1s,id:"minecraft:sharpness"}]},Count:1b},{id:"minecraft:iron_axe",tag:{Enchantments:[{lvl:1s,id:"minecraft:sharpness"}]},Count:1b}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': r'''Magma Charger'''
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Magma Charger\"}",Health:30.0f,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",tag:{display:{color:5066061}},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"1e2d1708-f4df-4eaa-8e94-e6345456347e",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzM2ODdlMjVjNjMyYmNlOGFhNjFlMGQ2NGMyNGU2OTRjM2VlYTYyOWVhOTQ0ZjRjZjMwZGNmYjRmYmNlMDcxIn19fQ=="}]}}},Count:1b}],Attributes:[{Base:30,Name:"generic.maxHealth"},{Base:0.275d,Name:"generic.movementSpeed"}],ActiveEffects:[{Ambient:0b,ShowIcon:1b,ShowParticles:1b,Duration:1999980,Id:8b,Amplifier:3b},{Ambient:0b,ShowIcon:1b,ShowParticles:1b,Duration:1999980,Id:14b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1999999,Id:12b,Amplifier:0b}],HandItems:[{id:"minecraft:golden_sword",tag:{Enchantments:[{lvl:4,id:"minecraft:sharpness"},{lvl:1,id:"minecraft:knockback"},{lvl:1,id:"minecraft:fire_aspect"}]},Count:1b},{}],CustomNameVisible:1}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
    ...
    # Yellow
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': r'''Aquarian Archer'''
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Aquarian Archer\"}",Health:30.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:33397,Name:"{\"italic\":false,\"text\":\"aquarian_archer_boots\"}"},Enchantments:[{lvl:1s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:34262077694496681L,UUIDLeast:-6937874110121253450L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:chainmail_leggings",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"aquarian_archer_leggings\"}"},AttributeModifiers:[{UUIDMost:-3348259744494632509L,UUIDLeast:-7132748624668974311L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:33397,Name:"{\"italic\":false,\"text\":\"aquarian_archer_chestplate\"}"},AttributeModifiers:[{UUIDMost:5565193625154307172L,UUIDLeast:-5630184456986470970L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Name:"Guardian"}}}],Attributes:[{Base:32.0d,Name:"generic.followRange"},{Base:30.0d,Name:"generic.maxHealth"},{Base:0.075d,Name:"generic.movementSpeed"}],AbsorptionAmount:0.0f,HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Aquarian Shortbow\"}"},Enchantments:[{lvl:4s,id:"minecraft:power"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Evolved Guardian'''
        },
        'mojangson': r'''{id:"minecraft:drowned",Health:35.0f,Attributes:[{Base:32.0d,Name:"generic.followRange"},{Base:0.23d,Name:"generic.movementSpeed"},{Base:35.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:trident",Count:1b},{}],CustomName:"[{\"text\":\"Evolved Guardian\",\"color\":\"gold\"}]",ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:16774619,Name:"{\"italic\":false,\"text\":\"evolved_guardian_boots\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:3765860678719524770L,UUIDLeast:-5432414709571914434L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:chainmail_leggings",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"evolved_guardian_leggings\"}"},AttributeModifiers:[{UUIDMost:2625891514944406138L,UUIDLeast:-6269367789506029608L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16774619,Name:"{\"italic\":false,\"text\":\"evolved_guardian_chestplate\"}"},Enchantments:[{lvl:2s,id:"minecraft:thorns"}],AttributeModifiers:[{UUIDMost:-2623837270524015058L,UUIDLeast:-6406086129033245656L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"e56a8749-8a4a-40cc-9ded-3c90f8ae8c63",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWM3OTc0ODJhMTRiZmNiODc3MjU3Y2IyY2ZmMWI2ZTZhOGI4NDEzMzM2ZmZiNGMyOWE2MTM5Mjc4YjQzNmIifX19"}]}}}}],Tags:["Elite"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Land Guardian'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Land Guardian\"}]",Health:20.0f,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:2659451,Name:"{\"italic\":false,\"text\":\"land_guardian_chestplate\"}"},AttributeModifiers:[{UUIDMost:7343286061065781312L,UUIDLeast:-7821914282794956699L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"4005cac1-a16a-45aa-9e72-7fb514335717",Properties:{textures:[{Signature:"",Value:""}]},Name:"MHF_Guardian"},Enchantments:[{lvl:2s,id:"minecraft:thorns"}]}}],Attributes:[{Base:20.0d,Name:"generic.maxHealth"},{Base:7.0d,Name:"generic.attackDamage"}],ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:14b,Amplifier:0b}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Water Spirit'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Water Spirit\"}]",IsBaby:1b,Health:10.0f,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:33023,Name:"{\"italic\":false,\"text\":\"water_spirit_chestplate\"}"},AttributeModifiers:[{UUIDMost:-5799195600123901260L,UUIDLeast:-4717379432341202162L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0b582b1b-8de8-4b5f-bfc6-d2585b318186",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWM3ZWNiZmQ2ZDMzZTg3M2ExY2Y5YTkyZjU3ZjE0NjE1MmI1MmQ5ZDczMTE2OTQ2MDI2NzExMTFhMzAyZiJ9fX0="}]}}}}],Attributes:[{Base:10.0d,Name:"generic.maxHealth"},{Base:0.18d,Modifiers:[{UUIDMost:-5082757096938257406L,UUIDLeast:-4891139119377885130L,Amount:0.5d,Operation:1,Name:"Baby speed boost"}],Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"}],ActiveEffects:[{Ambient:0b,ShowIcon:0b,ShowParticles:0b,Duration:99999999,Id:14b,Amplifier:0b}],HandItems:[{id:"minecraft:diamond_hoe",Count:1b,tag:{HideFlags:1,display:{Name:"{\"italic\":false,\"text\":\"Aqueous Scythe\"}"},Enchantments:[{lvl:1s,id:"minecraft:aqua_affinity"}],AttributeModifiers:[{UUIDMost:-6299659404845825479L,UUIDLeast:-7746443255638769651L,Amount:3.5d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:diamond_hoe",Count:1b,tag:{HideFlags:1,Enchantments:[{lvl:1s,id:"minecraft:aqua_affinity"}],AttributeModifiers:[{UUIDMost:462633899168646156L,UUIDLeast:-6256128536084544333L,Amount:0.0d,Slot:"offhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}}]}''',
    },
    # Yellow
    ################################################################################
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:drowned",HurtByTimestamp:0,IsBaby:1b,Attributes:[{Base:10.0d,Name:"generic.maxHealth"},{Base:0.0d,Name:"generic.knockbackResistance"},{Base:0.18d,Modifiers:[{UUIDMost:-5082757096938257406L,UUIDLeast:-4891139119377885130L,Amount:0.5d,Operation:1,Name:"Baby speed boost"}],Name:"generic.movementSpeed"},{Base:2.0d,Name:"generic.armor"},{Base:0.0d,Name:"generic.armorToughness"},{Base:30.0d,Name:"generic.followRange"},{Base:3.0d,Name:"generic.attackDamage"},{Base:0.0d,Name:"zombie.spawnReinforcements"}],Invulnerable:0b,FallFlying:0b,PortalCooldown:0,AbsorptionAmount:0.0f,InWaterTime:-1,FallDistance:0.0f,DeathTime:0s,WorldUUIDMost:-1041596277173696703L,HandDropChances:[-200.1f,-200.1f],PersistenceRequired:0b,Spigot.ticksLived:59,Tags:["NoLoot"],Motion:[0.0d,-0.0784000015258789d,0.0d],Leashed:0b,Health:10.0f,Bukkit.updateLevel:2,LeftHanded:0b,Air:236s,OnGround:1b,Dimension:0,HandItems:[{id:"minecraft:diamond_hoe",tag:{Enchantments:[{lvl:4,id:"minecraft:sharpness"}],Damage:0},Count:1b},{id:"minecraft:diamond_hoe",tag:{Enchantments:[{lvl:3,id:"minecraft:sharpness"}],Damage:0},Count:1b}],ArmorDropChances:[-200.1f,-200.1f,-200.1f,-200.1f],CustomName:"{\"text\":\"Water Spirit\"}",CanBreakDoors:0b,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",tag:{display:{color:33023},Damage:0},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"0b582b1b-8de8-4b5f-bfc6-d2585b318186",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWM3ZWNiZmQ2ZDMzZTg3M2ExY2Y5YTkyZjU3ZjE0NjE1MmI1MmQ5ZDczMTE2OTQ2MDI2NzExMTFhMzAyZiJ9fX0="}]}}},Count:1b}],Fire:-1s,CanPickUpLoot:0b,HurtTime:0s,WorldUUIDLeast:-7560693509725274339L,ActiveEffects:[{Ambient:0b,ShowIcon:0b,ShowParticles:0b,Duration:99999999,Id:14b,Amplifier:0b},{Ambient:0b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:13b,Amplifier:0b}],DrownedConversionTime:-1}''',
    },
    # Light Blue
    ################################################################################
    ...
    # Willows
    {
        'rules': {
            'id': 'minecraft:zombie',
            'CustomName': r'''Corrupted Leprechaun'''
        },
        'mojangson': r'''{id:"minecraft:zombie",Passengers:[{Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1200,Id:5b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1200,Id:26b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1200,Id:10b,Amplifier:0b}],Potion:"minecraft:empty"}},id:"minecraft:potion"}],CustomName:"{\"text\":\"Corrupted Leprechaun\"}",IsBaby:1,Health:10.0f,ArmorItems:[{id:"minecraft:golden_boots",tag:{},Count:1b},{id:"minecraft:leather_leggings",tag:{display:{color:484864}},Count:1b},{id:"minecraft:golden_chestplate",tag:{},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"b4211862-aa8d-449a-9193-002f32e69b8f",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzBmNDM5ZTljODJhZTM3MjJmOTcxNGYyNDI0NjhkYzJmM2QyMTRjNzZiMmVkNDI5NzUzMjZiNWNiZDdjMzgifX19"}]}}},Count:1b}],Attributes:[{Base:10,Name:"generic.maxHealth"},{Base:0.25d,Name:"generic.movementSpeed"},{Base:0.0f,Name:"zombie.spawnReinforcements"},{Base:40,Name:"generic.followRange"}],ActiveEffects:[{Duration:1999980,Id:8,Amplifier:1}],HandItems:[{id:"minecraft:golden_sword",tag:{Enchantments:[{lvl:1,id:"minecraft:sharpness"}]},Count:1b},{id:"minecraft:potion",Count:1b}]}''',
    },
    # Willows
    ################################################################################
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:blaze",CustomName:"{\"text\":\"Radiant Blaze\"}",Health:30.0f,Attributes:[{Base:30.0d,Name:"generic.maxHealth"}],Tags:["boss_fireball"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:blaze',
            'CustomName': 'Radiant Blaze'
        },
        'mojangson': r'''{id:"minecraft:blaze",CustomName:"{\"text\":\"Radiant Blaze\"}",Health:30.0f,Attributes:[{Base:30.0d,Name:"generic.maxHealth"}],Tags:["boss_fireball"]}''',
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Pyro Miner\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Boots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Pants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Tunic\"}"}}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:3416859,Name:"{\"text\":\"§fBurnt Helm\"}"}}}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:iron_pickaxe",Count:1b,tag:{display:{Name:"{\"text\":\"§bBasanite Miner\\u0027s Pick\"}"},AttributeModifiers:[{UUIDMost:6733323469324830937L,UUIDLeast:-4973487198358270803L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:zombie_pigman",Anger:32767s,CustomName:"{\"text\":\"Fire Imp\"}",Passengers:[{Potion:{id:"minecraft:splash_potion",tag:{CustomPotionEffects:[{Duration:600,Id:10,Amplifier:0},{Duration:1200,Id:12,Amplifier:0}],Potion:"minecraft:water"},Count:1},id:"minecraft:potion"}],IsBaby:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Boots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Pants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Tunic\"}"}}},{}],HandItems:[{id:"minecraft:blaze_powder",Count:1b,tag:{display:{Name:"{\"text\":\"§bBlazing Soul\"}"},Enchantments:[{lvl:1s,id:"minecraft:fire_aspect"}],AttributeModifiers:[{UUIDMost:-2899840319788137997L,UUIDLeast:-6474403868551417057L,Amount:5.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:6643163485254798509L,UUIDLeast:-9135644038788542450L,Amount:-0.08d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}},{id:"minecraft:blaze_powder",Count:1b,tag:{display:{Name:"{\"text\":\"§bBlazing Soul\"}"},Enchantments:[{lvl:1s,id:"minecraft:fire_aspect"}],AttributeModifiers:[{UUIDMost:-2899840319788137997L,UUIDLeast:-6474403868551417057L,Amount:5.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:6643163485254798509L,UUIDLeast:-9135644038788542450L,Amount:-0.08d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie_pigman',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Lost Soul\"}",Health:1.0f,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:11579568}}},{id:"minecraft:skeleton_skull",Count:1b}],Attributes:[{Base:1,Name:"generic.maxHealth"}],DeathLootTable:"minecraft:empty",ActiveEffects:[{Duration:99999999,Id:14b,Amplifier:0b}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:enderman",CustomName:"{\"text\":\"Spectral Enderman\"}",Health:40.0f,Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:24b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:14b,Amplifier:0b}],Tags:["boss_targetplayer"],HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§bSpectral Slicer\"}"},Enchantments:[{lvl:1s,id:"minecraft:fire_aspect"}],Damage:0,AttributeModifiers:[{UUIDMost:6758313694813700880L,UUIDLeast:-7432768362308561981L,Amount:6.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:zombie_pigman",CustomName:"{\"text\":\"§6Charred Foreman\"}",Health:90.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Boots\"}"}}},{id:"minecraft:golden_leggings",Count:1b,tag:{display:{Name:"{\"text\":\"§bBasanitePants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Tunic\"}"}}},{}],Attributes:[{Base:90.0d,Name:"generic.maxHealth"}],Tags:["Elite","boss_fireball"],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§bBasanite Spellblade\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-5443655948128206615L,UUIDLeast:-8115751551700471969L,Amount:10.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:magma_cream",Count:1b,tag:{display:{Name:"{\"text\":\"§bBasanite Magma\"}"}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"§6Magmatic Marksman\"}",Health:90.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:7352328,Name:"{\"text\":\"§fBurnt Boots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:7352328,Name:"{\"text\":\"§fBurnt Leggings\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:7352328,Name:"{\"text\":\"§fBurnt Cloak\"}"}}},{id:"minecraft:chainmail_helmet",Count:1b,tag:{display:{Name:"{\"text\":\"§4§lHellborn Crown\"}"}}}],Attributes:[{Base:90.0d,Name:"generic.maxHealth"}],Tags:["boss_fireball","Elite"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§bDemonbreath\"}"},Enchantments:[{lvl:3s,id:"minecraft:power"},{lvl:1s,id:"minecraft:flame"},{lvl:1s,id:"minecraft:punch"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:enderman",CustomName:"{\"text\":\"Spectral Enderman\"}",Health:40.0f,Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:24b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:14b,Amplifier:0b}],Tags:["boss_targetplayer"],HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§bSpectral Slicer\"}"},Enchantments:[{lvl:1s,id:"minecraft:fire_aspect"}],AttributeModifiers:[{UUIDMost:-5959315156678718861L,UUIDLeast:-8083021445480028083L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
    ...
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': 'Drowned Assassin'
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"{\"text\":\"Drowned Assassin\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:10531071,Name:"{\"text\":\"§fSky Mage Slippers\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:10531071,Name:"{\"text\":\"§fSky Mage Robe\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1073407,Name:"{\"text\":\"§aNereid Tunic\"}"},Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"3776820c-7098-42f8-864a-a8997c0f5b47",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDBmNzU4NWZlZjBkZWUwNDFmMzNhNjc5MTFkNzlmOTVhZDkwYzdkYjFmMmVjNTAxNTZmMzUzY2Y5NDFkYWY3MiJ9fX0="}]}},display:{Name:"{\"text\":\"§bDrowned Assasin\"}"}}}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],Tags:["boss_tpbehind","boss_float"],HandItems:[{id:"minecraft:stone_hoe",Count:1b,tag:{display:{Name:"{\"text\":\"§bFrostbite Scythe\"}"},Enchantments:[{lvl:2s,id:"minecraft:knockback"}],Damage:0,AttributeModifiers:[{UUIDMost:-1998017309584896710L,UUIDLeast:-5688441712466155383L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': 'Desert Mage'
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Desert Mage\"}",Health:30.0f,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,tag:{display:{Name:"{\"text\":\"§bAquamarineBoots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:14725264,Name:"{\"text\":\"§fWarlock Robe\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1784895,Name:"{\"text\":\"§bArcaneChest\"}"}}},{}],Attributes:[{Base:30.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§d§lSteelsiege\"}"},Enchantments:[{lvl:3s,id:"minecraft:power"}],Damage:0}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': r'''Frost Moon Knight'''
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"Frost Moon Knight\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},AttributeModifiers:[{UUIDMost:31492316112044816L,UUIDLeast:-8556528064959196441L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},AttributeModifiers:[{UUIDMost:2502059920319923451L,UUIDLeast:-7340807275252271259L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},AttributeModifiers:[{UUIDMost:7253508311050896534L,UUIDLeast:-8328577651339812818L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"},{Base:32.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§b§lFrozen Longbow\"}"},Enchantments:[{lvl:10s,id:"minecraft:power"}]}},{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:100,Id:2b,Amplifier:1b}],Potion:"minecraft:empty"}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
        ...
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"{\"text\":\"Frost Moon Knight\"}",Health:75.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},AttributeModifiers:[{UUIDMost:31492316112044816L,UUIDLeast:-8556528064959196441L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},AttributeModifiers:[{UUIDMost:2502059920319923451L,UUIDLeast:-7340807275252271259L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},AttributeModifiers:[{UUIDMost:7253508311050896534L,UUIDLeast:-8328577651339812818L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],Attributes:[{Base:75.0d,Name:"generic.maxHealth"},{Base:32.0d,Name:"generic.followRange"}],Tags:["boss_iceaspect"],HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§aPermafrost Spellblade\"}"},AttributeModifiers:[{UUIDMost:-7657272093998232210L,UUIDLeast:-8024280555932365120L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:shield",Count:1b,tag:{BlockEntityTag:{id:"minecraft:banner",Patterns:[{Pattern:"gra",Color:15},{Pattern:"gru",Color:3},{Pattern:"mc",Color:8},{Pattern:"tts",Color:0},{Pattern:"bts",Color:0},{Pattern:"bo",Color:0}],Base:15}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:zombie",CustomName:"{\"text\":\"Decayed Monstrosity\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:16776960,Name:"{\"text\":\"§fAlchemist\\u0027s Boots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:16776960,Name:"{\"text\":\"§fAlchemist\\u0027s Robe\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16776960,Name:"{\"text\":\"§fAlchemist\\u0027s Apron\"}"}}},{}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:rotten_flesh",Count:1b,tag:{display:{Name:"{\"text\":\"§bForgotten Flesh\"}"},AttributeModifiers:[{UUIDMost:1573681233954160957L,UUIDLeast:-7725953690619961493L,Amount:9.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:fermented_spider_eye",Count:1b,tag:{display:{Name:"{\"text\":\"§bRotten Eye\"}"}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': 'Ashen Archer'
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"{\"text\":\"Ashen Archer\"}",Health:26.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:1638400,Name:"{\"text\":\"§fAshen Treads\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}],Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:1638400,Name:"{\"text\":\"§fAshen Greaves\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}],Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1638400,Name:"{\"text\":\"§fAshen Mail\"}"},Enchantments:[{lvl:3s,id:"minecraft:protection"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"c9c757b6-19d1-4edd-987c-9fcdf2940006",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjcyNGU0NjZkMWRkMjRiMTcxYTcwNjRmZWM5YjFmNjFkOTYxZDBlMWZkNjRjNDk1NDExY2RmZjBmNzM3YmM5ZiJ9fX0="}]}}}}],Attributes:[{Base:26.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§fAshspitter\"}"},Enchantments:[{lvl:4s,id:"minecraft:power"}],Damage:0}},{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionColor:0,CustomPotionEffects:[{Ambient:0b,ShowIcon:1b,ShowParticles:1b,Duration:100,Id:15b,Amplifier:0b}],Potion:"minecraft:water"}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': '§6Oasis Assassin'
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"{\"text\":\"§6Oasis Assassin\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"oasis_assassin_boots\"}"},Damage:0}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"oasis_assassin_tunic\"}"},Damage:0}},{id:"minecraft:wither_skeleton_skull",Count:1b,tag:{Enchantments:[{lvl:4s,id:"minecraft:protection"},{lvl:4s,id:"minecraft:projectile_protection"},{lvl:4s,id:"minecraft:fire_protection"}]}}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:14b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:13b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:10b,Amplifier:0b}],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§1Assassin\\u0027s Bow\"}"},Enchantments:[{lvl:2s,id:"minecraft:power"},{lvl:1s,id:"minecraft:punch"}],Damage:0}},{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionColor:0,CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:18b,Amplifier:0b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:240,Id:20b,Amplifier:0b}],Potion:"minecraft:empty"}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': 'Land Guardian'
        },
        'mojangson': r'''{id:"minecraft:drowned",HurtByTimestamp:0,Leashed:0b,Health:20.0f,Bukkit.updateLevel:2,Attributes:[{Base:20.0d,Name:"generic.maxHealth"}],OnGround:1b,Dimension:0,PortalCooldown:0,AbsorptionAmount:0.0f,CustomName:"{\"text\":\"Land Guardian\"}",WorldUUIDMost:-1041596277173696703L,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",tag:{display:{color:2659451},Damage:0,AttributeModifiers:[{UUIDMost:4150212350119268030L,UUIDLeast:-7047679819971511977L,Amount:3.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"},{UUIDMost:3514264133762764575L,UUIDLeast:-7836892898038055430L,Amount:4.0d,Slot:"chest",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]},Count:1b},{id:"minecraft:player_head",tag:{SkullOwner:{Id:"4005cac1-a16a-45aa-9e72-7fb514335717",Properties:{textures:[{Signature:"",Value:""}]},Name:"MHF_Guardian"},Enchantments:[{lvl:2s,id:"minecraft:thorns"}]},Count:1b}],Spigot.ticksLived:8685,WorldUUIDLeast:-7560693509725274339L,ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:14b,Amplifier:0b}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': '§6Crystal Construct'
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",HurtByTimestamp:0,Attributes:[{Base:120.0d,Name:"generic.maxHealth"},{Base:0.0d,Name:"generic.knockbackResistance"},{Base:0.25d,Name:"generic.movementSpeed"},{Base:0.0d,Name:"generic.armor"},{Base:0.0d,Name:"generic.armorToughness"},{Base:16.0d,Name:"generic.followRange"},{Base:2.0d,Name:"generic.attackDamage"}],Invulnerable:0b,FallFlying:0b,PortalCooldown:0,AbsorptionAmount:0.0f,FallDistance:0.0f,DeathTime:0s,WorldUUIDMost:-1041596277173696703L,Spigot.ticksLived:782,Tags:["boss_pulselaser","boss_charger","Elite"],Leashed:0b,Health:120.0f,Bukkit.updateLevel:2,LeftHanded:0b,Air:300s,OnGround:1b,Dimension:0,HandItems:[{id:"minecraft:diamond",Count:1b,tag:{display:{Name:"{\"text\":\"§fPurple Crystal\"}"}}},{id:"minecraft:diamond",Count:1b,tag:{display:{Name:"{\"text\":\"§fBlue Crystal\"}"}}}],CustomName:"{\"text\":\"§6Crystal Construct\"}",Fire:-1s,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:projectile_protection"}],display:{color:9528739,Name:"{\"text\":\"§fCrystalConstructBoots\"}"},Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:projectile_protection"}],display:{color:4081300,Name:"{\"text\":\"§fCrystalConstructPants\"}"},Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:projectile_protection"}],display:{color:10904007,Name:"{\"text\":\"§fCrystalConstructChest\"}"},Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"a36651ec-9a21-4fd9-8df2-77e9cf3054b7",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTNjMjQ4NzBhNjVlNGYzZmE0M2I5MmYxOTRhM2M2ZjdlYzllNmNkNmM1MmYxZTY2MjRlNWMyNmI4ZGQ1ZDkifX19"}]}},display:{Name:"{\"text\":\"§fCrystalConstructHead\"}"},AttributeModifiers:[{UUIDMost:-8648734081702540279L,UUIDLeast:-9213755968225513728L,Amount:-0.1d,Slot:"head",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"},{UUIDMost:2069023236851909543L,UUIDLeast:-7476132564121657782L,Amount:6.0d,Slot:"head",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}}],CanPickUpLoot:0b,HurtTime:0s,WorldUUIDLeast:-7560693509725274339L}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
    ...
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
            'CustomName': 'Eternal Watcher'
        },
        'mojangson': r'''{id:"minecraft:zombie",CustomName:"{\"text\":\"Eternal Watcher\",\"color\":\"gold\"}",Passengers:[{CustomName:"{\"text\":\"§6Piercing Gaze\"}",Health:40.0f,Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],id:"minecraft:guardian",ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:99999999,Id:5b,Amplifier:1b}]},{Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:0,Id:7b,Amplifier:1b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:1b,Amplifier:2b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:5b,Amplifier:1b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:19b,Amplifier:1b}],Potion:"minecraft:empty"}},id:"minecraft:potion"}],Health:40.0f,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,tag:{Unbreakable:1b,AttributeModifiers:[{UUIDMost:9057155873620772162L,UUIDLeast:-6068076921249873586L,Amount:6.0d,AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:golden_leggings",Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:golden_chestplate",Count:1b,tag:{Unbreakable:1b}},{}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"},{Base:0.7d,Name:"generic.knockbackResistance"},{Base:0.2d,Name:"generic.movementSpeed"}],Tags:["Elite"],HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"Watcher\\u0027s Malice\"}"}}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
    ...
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
            'CustomName': r'''Mad Priest'''
        },
        'mojangson': r'''{id:"minecraft:zombie",CustomName:"{\"text\":\"Mad Priest\"}",Health:45.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:3290681,Name:"{\"text\":\"§fMadPriestBoots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:10528680,Name:"{\"text\":\"§fMadPriestPants\"}"},Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16383998,Name:"{\"text\":\"§fMadPriestChest\"}"}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"a9a3201f-ce46-4cb0-90fe-536d5472e2aa",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjRiNWI3NjhjMDk1NzAwMGQxZDk1NjdiMGU1NzI1OWJhMzZmNmJlYTYxYjcwYTQzMjc5YTJhZGMyZmVjMWZiYyJ9fX0="}]}},display:{Name:"{\"text\":\"§fMadPriestHead\"}"}}}],Attributes:[{Base:45.0d,Name:"generic.maxHealth"},{Base:0.35d,Name:"generic.movementSpeed"}],HandItems:[{id:"minecraft:stick",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:knockback"}],display:{Name:"{\"text\":\"§fMad Priest\\u0027s Stave\"}"},AttributeModifiers:[{UUIDMost:3902688665148015254L,UUIDLeast:-5841632532906738667L,Amount:6.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': r'''§6Corrupted Archbishop'''
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"{\"text\":\"§6Corrupted Archbishop\"}",Health:100.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:3290681,Name:"{\"text\":\"§fCorruptedArchbishopBoots\"}"},Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:10528680,Name:"{\"text\":\"§fCorruptedArchbishopPants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:4013890,Name:"{\"text\":\"§fCorruptedArchbishopChest\"}"},Enchantments:[{lvl:4s,id:"minecraft:projectile_protection"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"411aef9c-1a06-42ff-8d63-a627d82ba5a3",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzc2NWEwNTQ4YTA0ZmIyMjE1MGQzMTg5ZDdjZGI2OTgyYzEzZDc4NjBlMzIzNjY0NTVkMDU0NTc1MTY0ZTcwMSJ9fX0="}]}},display:{Name:"{\"text\":\"§fCorruptedArchbishopHead\"}"}}}],Attributes:[{Base:100.0d,Name:"generic.maxHealth"}],Tags:["Elite","boss_iceaspect","boss_frostnova"],HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§fArchbishop\\u0027s Axe\"}"},Enchantments:[{lvl:2s,id:"minecraft:knockback"},{lvl:2s,id:"minecraft:sharpness"},{lvl:1s,id:"minecraft:fire_aspect"}]}},{id:"minecraft:enchanted_book",Count:1b,tag:{display:{Name:"{\"text\":\"§fCorruptedArchbishopBook\"}"},StoredEnchantments:[{lvl:3s,id:"minecraft:depth_strider"}]}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:creeper',
            'CustomName': r'''Spectral Creeper'''
        },
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:witch",CustomName:"{\"text\":\"§6Insectomancer\"}",Health:60.0f,Attributes:[{Base:60.0d,Name:"generic.maxHealth"}],Tags:["Elite","boss_gray_summ_bug","boss_player_dmg_only"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:evoker',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:evoker",HurtByTimestamp:0,Leashed:0b,Health:70.0f,Bukkit.updateLevel:2,Attributes:[{Base:70.0d,Name:"generic.maxHealth"},{Base:32.0d,Name:"generic.followRange"}],OnGround:1b,Dimension:0,PortalCooldown:0,AbsorptionAmount:0.0f,HandItems:[{id:"minecraft:stone_shovel",Count:1b,tag:{display:{Name:"{\"text\":\"§aPyromancer\\u0027s Staff\"}"},Enchantments:[{lvl:1s,id:"minecraft:power"}],Damage:0}},{id:"minecraft:totem_of_undying",Count:1b,tag:{display:{Name:"{\"text\":\"§e§lTotem of the Veil\"}"}}}],CustomName:"{\"text\":\"§6Demon Conjurer\"}",WorldUUIDMost:-1041596277173696703L,ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",Count:1b,tag:{Enchantments:[{lvl:3s,id:"minecraft:projectile_protection"}]}}],Spigot.ticksLived:418,Tags:["Elite","boss_gray_summ_demon","boss_player_dmg_only","boss_evoker_no_vex"],WorldUUIDLeast:-7560693509725274339L,CustomNameVisible:0b}''',
    },
    {
        'rules': {
            'id': 'minecraft:witch',
        ...
        'mojangson': r'''{id:"minecraft:witch",CustomName:"{\"text\":\"§6Bibliomancer\"}",Health:60.0f,Attributes:[{Base:60.0d,Name:"generic.maxHealth"}],Tags:["Elite","boss_gray_summ_book","boss_player_dmg_only"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
        ...
        'mojangson': r'''{id:"minecraft:skeleton",HurtByTimestamp:0,Leashed:0b,Health:40.0f,Bukkit.updateLevel:2,Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],OnGround:1b,Dimension:0,PortalCooldown:0,AbsorptionAmount:0.0f,HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§fSkullcrusher\"}"},Damage:0,AttributeModifiers:[{UUIDMost:6532206609118478368L,UUIDLeast:-8955621743513098640L,Amount:0.8d,Slot:"mainhand",AttributeName:"generic.knockbackResistance",Operation:0,Name:"Modifier"},{UUIDMost:900361441649510602L,UUIDLeast:-7130602121338408403L,Amount:14.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:-463252452232638665L,UUIDLeast:-4687319287056168669L,Amount:0.15d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}},{}],CustomName:"{\"text\":\"Desiccated Terror\"}",WorldUUIDMost:-1041596277173696703L,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:1908001,Name:"{\"text\":\"§bGrayBoots\"}"},Damage:0}},{id:"minecraft:chainmail_leggings",Count:1b,tag:{display:{Name:"{\"text\":\"§9§lIronscale Leggings\"}"},Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1908001,Name:"{\"text\":\"§bGrayChest2\"}"},Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"5554d596-e473-49d7-b6d4-6e7fad49a9f2",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmZkOWM2ZjFkYzQ5Njc3NTUyNTk1YjZlODJmMTI5Njc3OGZiMGJkZDNlMGJjN2MxNTQwODRlYTJlMzMxNDRmIn19fQ=="}]}},display:{Name:"{\"text\":\"§bGrayMummyHead2\"}"}}}],Spigot.ticksLived:3604,WorldUUIDLeast:-7560693509725274339L}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
        ...
        'mojangson': r'''{id:"minecraft:skeleton",HurtByTimestamp:4615,Leashed:0b,Health:45.0f,Bukkit.updateLevel:2,Attributes:[{Base:45.0d,Name:"generic.maxHealth"}],OnGround:1b,Dimension:0,PortalCooldown:0,AbsorptionAmount:0.0f,HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§fObsidian Blade\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-2483446473759634744L,UUIDLeast:-7254151480308536732L,Amount:10.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:-1575746377282469550L,UUIDLeast:-7704976322174616712L,Amount:0.05d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}},{}],CustomName:"{\"text\":\"Desiccated Brute\"}",WorldUUIDMost:-1041596277173696703L,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:1908001,Name:"{\"text\":\"§bGrayBoots\"}"},Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:7567221,Name:"{\"text\":\"§bGrayPants\"}"},Damage:0}},{id:"minecraft:chainmail_chestplate",Count:1b,tag:{display:{Name:"{\"text\":\"§7§lWhispering Chains\"}"},Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"8f7c0c5b-720f-4944-8481-b0f7931f303f",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2U5MWU5NTgyMmZlOThjYzVhNTY1OGU4MjRiMWI4Y2YxNGQ0ZGU5MmYwZTFhZjI0ODE1MzcyNDM1YzllYWI2In19fQ=="}]}},display:{Name:"{\"text\":\"§bGrayMummyHead\"}"}}}],Spigot.ticksLived:16363,WorldUUIDLeast:-7560693509725274339L}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie_villager',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:vindicator",CustomName:"{\"text\":\"Harmonic Adherent\"}",Health:35.0f,Attributes:[{Base:35.0d,Name:"generic.maxHealth"}],Team:"mobs",HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§fObsidian Blade\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-3465215994192836721L,UUIDLeast:-7525682249439399290L,Amount:7.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': 'Autumn Spirit'
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"{\"text\":\"Autumn Spirit\"}",Health:45.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:8805175,Name:"{\"text\":\"§fLeafweave Sandals\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:8743475,Name:"{\"text\":\"§fLeafweave Trousers\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:8543535,Name:"{\"text\":\"§a§lVinebound Tunic\"}"}}},{id:"minecraft:spruce_leaves",Count:1b}],Attributes:[{Base:45.0d,Name:"generic.maxHealth"}],Team:"mobs",HandItems:[{id:"minecraft:golden_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§c§lAutumn Wind\"}"},Enchantments:[{lvl:4s,id:"minecraft:knockback"}],Damage:0,AttributeModifiers:[{UUIDMost:6478663521670483287L,UUIDLeast:-6389870882906058091L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie_pigman',
        ...
        'mojangson': r'''{id:"minecraft:zombie_pigman",Anger:32767s,CustomName:"{\"text\":\"Akaname\"}",IsBaby:1b,Health:35.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:16195840,Name:"{\"text\":\"fInfernal Boots\"}"},Damage:0}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:16195840,Name:"{\"text\":\"fInfernal Pants\"}"},Damage:0}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16195840,Name:"{\"text\":\"fInfernal Tunic\"}"},Damage:0}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"3ab9a743-9175-4616-9eef-5e5444818ed6",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTc5ODc4ZDdjOWMwMDk0MGExM2Y1ZjliMzI3MWQ5OTcwZmYxYTEyZGQxYzViN2Y4Zjg3OGQwOGZhNjYwNzY4ZSJ9fX0="}]}},display:{Name:"{\"text\":\"Nether Wart Pigman\"}"}}}],Attributes:[{Base:35.0d,Name:"generic.maxHealth"}],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§6§lSmouldering Flame\"}"},Damage:0,AttributeModifiers:[{UUIDMost:7436242603495737492L,UUIDLeast:-7374483167421956809L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:4462919074345864273L,UUIDLeast:-6758640384939453739L,Amount:-0.12d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}},{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§6§lSmouldering Flame\"}"},Damage:0,AttributeModifiers:[{UUIDMost:7436242603495737492L,UUIDLeast:-7374483167421956809L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:4462919074345864273L,UUIDLeast:-6758640384939453739L,Amount:-0.12d,Slot:"mainhand",AttributeName:"generic.movementSpeed",Operation:1,Name:"Modifier"}]}}]}''',
    },
    # Pink mobs
    ################################################################################
    ...
    # Cyan mobs
    {
        # NOTE: RENAME TO ASTAROTH
        'rules': {
            'id': 'minecraft:wither',
            'CustomName': '§6Eldritch Demon'
        },
        'mojangson': r'''{id:"minecraft:wither",CustomName:"{\"text\":\"§6ASTAROTH\"}",Health:160.0f,Attributes:[{Base:160.0d,Name:"generic.maxHealth"}],DeathLootTable:"empty",Tags:["Elite"]}''',
    },
    # Cyan mobs
    ################################################################################
    ...
    # Light Gray Mobs
    {
        'rules': {
            'id': 'minecraft:vindicator',
            'CustomName': r'''Alutana's Devoted'''
        },
        'mojangson': r'''{id:"minecraft:vindicator",CustomName:"[{\"text\":\"Alutana\\u0027s Devoted\"}]",Health:30.0f,Attributes:[{Base:30.0d,Name:"generic.maxHealth"},{Base:0.4d,Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"}],Tags:["boss_berserker"],HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§6§lQuerter\\u0027s Hatchet\"}"},AttributeModifiers:[{UUIDMost:-6854216625839389042L,UUIDLeast:-5746908136694100016L,Amount:10.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:totem_of_undying",Count:1b,tag:{AttributeModifiers:[{UUIDMost:-2319843372370080279L,UUIDLeast:-6263989117147514441L,Amount:-0.1d,Slot:"offhand",AttributeName:"generic.movementSpeed",Operation:0,Name:"Modifier"}]}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:spider',
            'CustomName': r'''Wolf Spider'''
        },
        'mojangson': r'''{id:"minecraft:spider",CustomName:"[{\"text\":\"Wolf Spider\"}]",Health:40.0f,Attributes:[{Base:0.25d,Name:"generic.movementSpeed"},{Base:40.0d,Name:"generic.maxHealth"},{Base:32.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:bone",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Crushing Bite\"}"},AttributeModifiers:[{UUIDMost:-3564283386566917213L,UUIDLeast:-8614227812141559677L,Amount:13.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:stray',
            'CustomName': r'''Follower of Alutana'''
        },
        'mojangson': r'''{id:"minecraft:stray",CustomName:"[{\"text\":\"Follower of Alutana\"}]",Health:25.0f,Attributes:[{Base:0.3d,Name:"generic.movementSpeed"},{Base:25.0d,Name:"generic.maxHealth"},{Base:32.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§fStorm Dagger\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-9012139191445993181L,UUIDLeast:-7426312281344377946L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Frost Moon Retiarius'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Frost Moon Retiarius\"}]",Health:50.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},AttributeModifiers:[{UUIDMost:31492316112044816L,UUIDLeast:-8556528064959196441L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},AttributeModifiers:[{UUIDMost:2502059920319923451L,UUIDLeast:-7340807275252271259L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},AttributeModifiers:[{UUIDMost:7253508311050896534L,UUIDLeast:-8328577651339812818L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],Attributes:[{Base:0.3d,Name:"generic.movementSpeed"},{Base:50.0d,Name:"generic.maxHealth"}],Tags:["boss_frostnova"],HandItems:[{id:"minecraft:trident",Count:1b},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:creeper',
            'CustomName': r'''Creeping Frost'''
        },
        'mojangson': r'''{id:"minecraft:creeper",Fuse:30s,powered:1b,CustomName:"[{\"text\":\"Creeping Frost\"}]",Passengers:[{CustomName:"[{\"text\":\"Frostbite\"}]",Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:2b,Amplifier:4b}],Potion:"minecraft:empty"}},id:"minecraft:potion"}],Health:40.0f,Attributes:[{Base:40.0d,Name:"generic.maxHealth"},{Base:0.25d,Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"}],ExplosionRadius:3b,Tags:["boss_invisible"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:illusioner',
            'CustomName': r'''Shadow Magician'''
        },
        'mojangson': r'''{id:"minecraft:illusioner",CustomName:"[{\"text\":\"Shadow Magician\",\"color\":\"gold\"}]",Health:75.0f,Attributes:[{Base:0.25d,Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"},{Base:75.0d,Name:"generic.maxHealth"}],PersistenceRequired:0b,Tags:["Elite"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§9§lArcane Hailstorm\"}"},Enchantments:[{lvl:30s,id:"minecraft:power"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': r'''Abyss Walker'''
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"[{\"text\":\"Abyss Walker\",\"color\":\"gold\",\"italic\":false}]",Health:100.0f,ArmorItems:[{id:"minecraft:iron_boots",Count:1b,tag:{display:{Name:"[{\"text\":\"Artorias Sabatons\",\"italic\":false}]"},AttributeModifiers:[{UUIDMost:-3295258945912094186L,UUIDLeast:-8619206371773143313L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:iron_leggings",Count:1b,tag:{display:{Name:"[{\"text\":\"Artorias Greaves\",\"italic\":false}]"},AttributeModifiers:[{UUIDMost:-8510758600228714320L,UUIDLeast:-6770491122738809438L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:iron_chestplate",Count:1b,tag:{display:{Name:"[{\"text\":\"Artorias Chestplate\",\"italic\":false}]"},AttributeModifiers:[{UUIDMost:-1795547384333775038L,UUIDLeast:-8248417804632390341L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:iron_helmet",Count:1b,tag:{display:{Name:"[{\"text\":\"Artorias Helm\",\"italic\":false}]"},AttributeModifiers:[{UUIDMost:1886392941155536342L,UUIDLeast:-8716603333637893885L,Amount:0.0d,Slot:"head",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}}],Attributes:[{Base:64.0d,Name:"generic.followRange"},{Base:100.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:0.25d,Name:"generic.movementSpeed"}],PersistenceRequired:1b,Tags:["Elite","boss_icebreak","boss_punchresist"],HandItems:[{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§6§lTelum Immoriel\"}"},AttributeModifiers:[{UUIDMost:1865971757628606718L,UUIDLeast:-7623679339945156749L,Amount:17.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
            'CustomName': r'''Frost Walker'''
        },
        'mojangson': r'''{id:"minecraft:zombie",CustomName:"[{\"text\":\"Frost Walker\",\"color\":\"gold\",\"italic\":false}]",Health:100.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:9107455,Name:"{\"text\":\"§1§lShadowborn Boots\"}"},Enchantments:[{lvl:1s,id:"minecraft:frost_walker"}],AttributeModifiers:[{UUIDMost:-2901150132793618720L,UUIDLeast:-7452380719059955617L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:9107455,Name:"{\"text\":\"§6§lAngelic Pants\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-5251194054458392225L,UUIDLeast:-7005531168019553204L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:9107455,Name:"{\"text\":\"§aDualsun Cloak\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-4910268315206138886L,UUIDLeast:-7906791285969060931L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:9107455,Name:"{\"text\":\"§b§lIceborn Helmet\"}"},Damage:0,AttributeModifiers:[{UUIDMost:8574503869910499943L,UUIDLeast:-6042447625829930243L,Amount:0.0d,Slot:"head",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}}],Attributes:[{Base:100.0d,Name:"generic.maxHealth"},{Base:0.3d,Name:"generic.movementSpeed"}],PersistenceRequired:1b,Tags:["Elite"],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§1§lFrigid Firangi\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-6229534957462929064L,UUIDLeast:-8585543351639402056L,Amount:17.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:iron_golem',
            'CustomName': r'''Frost Golem'''
        },
        'mojangson': r'''{id:"minecraft:iron_golem",CustomName:"[{\"text\":\"Frost Golem\",\"color\":\"gold\",\"italic\":false}]",Health:200.0f,Attributes:[{Base:1.0d,Name:"generic.knockbackResistance"},{Base:200.0d,Name:"generic.maxHealth"},{Base:0.15d,Name:"generic.movementSpeed"},{Base:25.0d,Name:"generic.attackDamage"}],PersistenceRequired:1b,AttackTime:1s,Tags:["Elite","boss_iceaspect","boss_targetplayer"],HandItems:[{id:"minecraft:poppy",Count:1b,tag:{HideFlags:0,display:{Name:"{\"italic\":false,\"text\":\"Frost Covenant\"}"}}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
            'CustomName': r'''Frost Moon's Shadow'''
        },
        'mojangson': r'''{id:"minecraft:skeleton",CustomName:"[{\"text\":\"Frost Moon\\u0027s Shadow\"}]",Health:50.0f,ArmorItems:[{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16777215,Name:"{\"text\":\"§3§lCobaltean Cape\"}"},AttributeModifiers:[{UUIDMost:6138072622905640482L,UUIDLeast:-5532826880256379464L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:16777215,Name:"{\"text\":\"§3§lCap of Fear\"}"},AttributeModifiers:[{UUIDMost:8541959490611531199L,UUIDLeast:-5625989978383676761L,Amount:0.0d,Slot:"head",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}}],Attributes:[{Base:64.0d,Name:"generic.followRange"},{Base:50.0d,Name:"generic.maxHealth"},{Base:0.25d,Name:"generic.movementSpeed"}],Tags:["boss_weaponswitch"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§aFinal Crescent\"}"},Enchantments:[{lvl:15s,id:"minecraft:power"}]}},{id:"minecraft:stone_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§5§lMorphic Blade\"}"},AttributeModifiers:[{UUIDMost:-4913528042696979957L,UUIDLeast:-5738641516306354639L,Amount:13.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:-6834513977444578542L,UUIDLeast:-8722490695285790058L,Amount:-0.05d,Slot:"offhand",AttributeName:"generic.movementSpeed",Operation:0,Name:"Modifier"}]}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:evoker',
            'CustomName': r'''Priest of Alutana'''
        },
        'mojangson': r'''{id:"minecraft:evoker",CustomName:"[{\"text\":\"Priest of Alutana\",\"color\":\"gold\"}]",Health:100.0f,Attributes:[{Base:100.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:0.35d,Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"}],PersistenceRequired:0b,Tags:["Elite","boss_evoker_no_vex","boss_rejuvenation","boss_player_dmg_only"]}''',
    },
    # Light Gray Mobs
    ################################################################################
    ...
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Drowned Lancer'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Drowned Lancer\"}]",Health:100.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:6252903,Name:"{\"text\":\"§fFur Boots\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:5485816264229864503L,UUIDLeast:-8025614248440623879L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:7372155,Name:"{\"text\":\"§aPlaguehide Pants\"}"},AttributeModifiers:[{UUIDMost:-2740990636941029770L,UUIDLeast:-7105078174313552285L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:7372155,Name:"{\"text\":\"§a§lVinebound Tunic\"}"},AttributeModifiers:[{UUIDMost:-2860069127825963382L,UUIDLeast:-5813863396208373679L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"d11d3a37-8fcb-43e6-a46f-63ebd90f659e",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzFhNzMyNTI0MDFhNmU5NDZmNjFkYmFjMGUwMjdkMTgzZTBhY2U1ODc1MmZhMTVhNjRkMjQ0OWZjZjUwODdiNyJ9fX0="}]}},display:{}}}],Attributes:[{Base:100.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:trident",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Prismatic Pike\"}"},AttributeModifiers:[{UUIDMost:1884298565667800838L,UUIDLeast:-4838243406076806638L,Amount:36.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:stray',
            'CustomName': r'''Tutelary Spirit'''
        },
        'mojangson': r'''{id:"minecraft:stray",CustomName:"[{\"text\":\"Tutelary Spirit\"}]",Health:60.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"§aSoulleather Shoes\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:7540933473533444898L,UUIDLeast:-6717788279730608685L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"§aSoulleather Robe\"}"},AttributeModifiers:[{UUIDMost:6471685917605186337L,UUIDLeast:-5725344995972228801L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"§aSoulleather Cloak\"}"},AttributeModifiers:[{UUIDMost:-7286025212327409021L,UUIDLeast:-6559093199055774268L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:0,Name:"{\"text\":\"§aSoulleather Veil\"}"},AttributeModifiers:[{UUIDMost:-5667913726316558953L,UUIDLeast:-7987438630589365482L,Amount:0.0d,Slot:"head",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}}],Attributes:[{Base:60.0d,Name:"generic.maxHealth"},{Base:0.3d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"}],Tags:["boss_hidden","boss_addarmor"],HandItems:[{id:"minecraft:stick",Count:1b,tag:{display:{Name:"{\"text\":\"§b§lThaumaturge\\u0027s Greed\"}"},AttributeModifiers:[{UUIDMost:-6890172516491706204L,UUIDLeast:-5786234737523425889L,Amount:13.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Water Wisp'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Water Wisp\"}]",IsBaby:1b,Health:75.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:1073407,Name:"{\"text\":\"§aNereid Sandals\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:5225150667289477596L,UUIDLeast:-6080452553714319116L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:9885152,Name:"{\"text\":\"§fCerulean Mage Robes\"}"},AttributeModifiers:[{UUIDMost:-7330304342563666543L,UUIDLeast:-8247513943861980317L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0b56e5b6-5db6-42fb-b394-90608ac8fcbe",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmE1ODNmZGIxNmU0Mzk5ZDI4OGE2MmIzOTAxNzNjYWU0YzNiMjQxMGQ1ZDc0N2FlMTE5NDJlMGJjYjU2NjM1ZSJ9fX0="}]}}}}],Attributes:[{Base:75.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:0.15d,Name:"generic.movementSpeed"}],Tags:["boss_weaponswitch","boss_invisible"],HandItems:[{id:"minecraft:trident",Count:1b,tag:{AttributeModifiers:[{UUIDMost:392285557149615493L,UUIDLeast:-6405226990079560650L,Amount:18.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:stick",Count:1b,tag:{display:{Name:"{\"text\":\"§aWand of Storms\"}"},AttributeModifiers:[{UUIDMost:624098218259466969L,UUIDLeast:-8095622324813235030L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Inundated Draugr'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Inundated Draugr\"}]",Health:135.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:2502448,Name:"{\"text\":\"§fCloth Shoes\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:8151891606044297994L,UUIDLeast:-7722334274888178576L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:2502448,Name:"{\"text\":\"§fCloth Pants\"}"},AttributeModifiers:[{UUIDMost:-4345728380504357153L,UUIDLeast:-6257690072762414707L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:2502448,Name:"{\"text\":\"§fCloth Shirt\"}"},AttributeModifiers:[{UUIDMost:-5517283433701489063L,UUIDLeast:-7776465610838995910L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0f438f37-4166-4ce1-9b40-bfab16a7f29f",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTUzOWYyNjQ5ZDU0MWM2OGYzZDBmOWQzNzU4ZDkzYzdiYWFjMTcxZTRkNzA5MWE4NGQ4YTM2Mjg5MTQ4YjYyNSJ9fX0="}]}}}}],Attributes:[{Base:135.0d,Name:"generic.maxHealth"},{Base:0.35d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:stone_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§3§lMithril Cleaver\"}"},Enchantments:[{lvl:1s,id:"minecraft:fire_aspect"},{lvl:1s,id:"minecraft:knockback"}],AttributeModifiers:[{UUIDMost:-4189142210130457947L,UUIDLeast:-4974667142826157465L,Amount:17.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Sodden Corpse'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Sodden Corpse\",\"color\":\"gold\"}]",Passengers:[{CustomName:"[{\"text\":\"Corpse Possessor\",\"color\":\"gold\"}]",Health:100.0f,Attributes:[{Base:100.0d,Name:"generic.maxHealth"},{Base:0.3d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"},{Base:20.0d,Name:"generic.attackDamage"}],Silent:1b,id:"minecraft:guardian",Tags:["Elite"]}],Health:225.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:6252903,Name:"{\"text\":\"§fBandit\\u0027s Boots\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:8283392819243862858L,UUIDLeast:-6761338060964078388L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:7372155,Name:"{\"text\":\"§fScoundrel\\u0027s Trousers\"}"},AttributeModifiers:[{UUIDMost:6854348570093242073L,UUIDLeast:-6580178524329005905L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:10072236,Name:"{\"text\":\"§fBrigand\\u0027s Tunic\"}"},AttributeModifiers:[{UUIDMost:3612403347900943719L,UUIDLeast:-7666735338925091412L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{}],Attributes:[{Base:225.0d,Name:"generic.maxHealth"},{Base:0.4d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"}],PersistenceRequired:0b,Tags:["Elite"],HandItems:[{id:"minecraft:iron_hoe",Count:1b,tag:{display:{Name:"{\"text\":\"§fSeawater Razor\"}"},AttributeModifiers:[{UUIDMost:-8486678022247201685L,UUIDLeast:-8518554479247957116L,Amount:17.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
            'CustomName': r'''Prismatic Guardian'''
        },
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"[{\"text\":\"Prismatic Guardian\",\"color\":\"gold\"}]",Health:270.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:7138262,Name:"{\"text\":\"§fMolten Boots\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:-944856366505046841L,UUIDLeast:-6105144497961504631L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:7138262,Name:"{\"text\":\"§fMolten Pants\"}"},AttributeModifiers:[{UUIDMost:3888304676118810404L,UUIDLeast:-4807977090837825753L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:7138262,Name:"{\"text\":\"§fMolten Cloak\"}"},AttributeModifiers:[{UUIDMost:-1910290038600611430L,UUIDLeast:-6235118465610640621L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{}],Attributes:[{Base:270.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:0.275d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"}],PersistenceRequired:0b,Tags:["Elite","boss_charger"],HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§aPerilous Zweihander\"}"},AttributeModifiers:[{UUIDMost:2778343276251138293L,UUIDLeast:-6183743212280026582L,Amount:22.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:stray',
            'CustomName': r'''Antediluvian Aquamancer'''
        },
        'mojangson': r'''{id:"minecraft:stray",CustomName:"[{\"text\":\"Antediluvian Aquamancer\",\"color\":\"gold\"}]",Health:75.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:5212828,Name:"{\"text\":\"§fFur Boots\"}"},Enchantments:[{lvl:1s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:5386322013538897733L,UUIDLeast:-8998162946674457598L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:5415325,Name:"{\"text\":\"§fCerulean Mage Robes\"}"},AttributeModifiers:[{UUIDMost:-1995641301730177409L,UUIDLeast:-5515609166516412329L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:7126421,Name:"{\"text\":\"§fCerulean Mage Robes\"}"},AttributeModifiers:[{UUIDMost:-631563309361249866L,UUIDLeast:-8025764122455886580L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"aebaed94-875d-427a-9d9b-c44390fbd8ba",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGQ4OGZhNzRkYzkyZWUxMDQ0NmVmYjg2YWQ1YzZjOTVhMzk4ZTMxMjU5Y2RlNTIxYWE3MzIyZWY5MmRjMjEzYiJ9fX0="}]}},display:{}}}],Attributes:[{Base:75.0d,Name:"generic.maxHealth"},{Base:0.225d,Name:"generic.movementSpeed"},{Base:128.0d,Name:"generic.followRange"}],PersistenceRequired:0b,Tags:["boss_rejuvenation","Elite"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§8§lShadow\\u0027s Flames\"}"},Enchantments:[{lvl:30s,id:"minecraft:power"}]}},{id:"minecraft:tipped_arrow",Count:64b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:100,Id:2b,Amplifier:1b}],Potion:"minecraft:empty"}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Whirlpool Wisp'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Whirlpool Wisp\"}]",Passengers:[{Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:600,Id:13b,Amplifier:0b}],Potion:"minecraft:empty",display:{Name:"{\"italic\":false,\"text\":\"Air Bubble\"}"}}},id:"minecraft:potion"}],IsBaby:0b,Health:68.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:1073407,Name:"{\"text\":\"§aNereid Sandals\"}"},Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:5225150667289477596L,UUIDLeast:-6080452553714319116L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:1073407,Name:"{\"text\":\"§aNereid Leggings\"}"},AttributeModifiers:[{UUIDMost:-6054944476838082908L,UUIDLeast:-5325785490012413921L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:9885152,Name:"{\"text\":\"§fCerulean Mage Robes\"}"},AttributeModifiers:[{UUIDMost:-7330304342563666543L,UUIDLeast:-8247513943861980317L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0b56e5b6-5db6-42fb-b394-90608ac8fcbe",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmE1ODNmZGIxNmU0Mzk5ZDI4OGE2MmIzOTAxNzNjYWU0YzNiMjQxMGQ1ZDc0N2FlMTE5NDJlMGJjYjU2NjM1ZSJ9fX0="}]}}}}],Attributes:[{Base:68.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:0.5d,Name:"generic.movementSpeed"}],Tags:["boss_invisible"],HandItems:[{id:"minecraft:stick",Count:1b,tag:{display:{Name:"{\"text\":\"§aWand of Storms\"}"},AttributeModifiers:[{UUIDMost:-8310566656045921615L,UUIDLeast:-7086168611596719553L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:creeper',
            'CustomName': r'''Animated Algae'''
        },
        'mojangson': r'''{id:"minecraft:creeper",Fuse:20s,CustomName:"[{\"text\":\"Animated Algae\"}]",Passengers:[{Potion:{id:"minecraft:lingering_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:17b,Amplifier:127b}],Potion:"minecraft:empty",display:{Name:"{\"italic\":false,\"text\":\"Algae Poisoning\"}"}}},id:"minecraft:potion"}],Health:68.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],AttributeModifiers:[{UUIDMost:-8776597148285647765L,UUIDLeast:-9206484756231977365L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{},{},{}],Attributes:[{Base:68.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"}],ExplosionRadius:4b}''',
    },
    {
        'rules': {
            'id': 'minecraft:squid',
            'CustomName': r'''Frightened Squid'''
        },
        'mojangson': r'''{id:"minecraft:squid",CustomName:"[{\"text\":\"Frightened Squid\"}]",Passengers:[{ReapplicationDelay:40,Radius:2.5f,CustomName:"[{\"text\":\"Ink Cloud\"}]",Duration:600,id:"minecraft:area_effect_cloud",Effects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:60,Id:15b,Amplifier:0b}]},{Potion:{id:"minecraft:lingering_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:60,Id:15b,Amplifier:0b}],Potion:"minecraft:empty"}},id:"minecraft:potion"}],Health:45.0f,Attributes:[{Base:45.0d,Name:"generic.maxHealth"}],Tags:["boss_blindcloud"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Drowned Thrall'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Drowned Thrall\"}]",Health:180.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],display:{color:4409980},AttributeModifiers:[{UUIDMost:-8776597148285647765L,UUIDLeast:-9206484756231977365L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:4409980},AttributeModifiers:[{UUIDMost:1188612004481876511L,UUIDLeast:-5821744835140493444L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{},{}],Attributes:[{Base:180.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:0.2d,Name:"generic.movementSpeed"}],Tags:["boss_unstable"],ActiveEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:600,Id:6b,Amplifier:0b}],HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Gargling Grab\"}"},AttributeModifiers:[{UUIDMost:-4430852776915285497L,UUIDLeast:-8363808967403922257L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:guardian',
            'CustomName': r'''Phaser Assassin'''
        },
        'mojangson': r'''{id:"minecraft:guardian",CustomName:"[{\"text\":\"Phaser Assassin\",\"color\":\"gold\"}]",Health:90.0f,Attributes:[{Base:90.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:15.0d,Name:"generic.attackDamage"}],PersistenceRequired:0b,Tags:["Elite"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Skewer Fisherman'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Skewer Fisherman\",\"color\":\"gold\"}]",Passengers:[{CustomName:"[{\"text\":\"Undead Fisherman\\u0027s Tonic\"}]",Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:600,Id:1b,Amplifier:1b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:7b,Amplifier:1b}],Potion:"minecraft:empty",display:{Name:"{\"italic\":false,\"text\":\"Undead Fisherman\\u0027s Tonic\"}"}}},id:"minecraft:potion"}],Health:135.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Enchantments:[{lvl:3s,id:"minecraft:depth_strider"}],display:{color:4409980},AttributeModifiers:[{UUIDMost:-8776597148285647765L,UUIDLeast:-9206484756231977365L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:4409980},AttributeModifiers:[{UUIDMost:1188612004481876511L,UUIDLeast:-5821744835140493444L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16725301,Name:"{\"text\":\"§rTlaxan Priest Robe\"}"},AttributeModifiers:[{UUIDMost:6244128172798787786L,UUIDLeast:-8468974444263739158L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:16725301,Name:"{\"text\":\"§d§lFisherman\\u0027s Cap\"}"},AttributeModifiers:[{UUIDMost:-8226535867445522848L,UUIDLeast:-5390949661264407625L,Amount:0.0d,Slot:"head",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}}],Attributes:[{Base:128.0d,Name:"generic.followRange"},{Base:135.0d,Name:"generic.maxHealth"},{Base:0.35d,Name:"generic.movementSpeed"}],PersistenceRequired:0b,Tags:["Elite","aura_slowness"],HandItems:[{id:"minecraft:trident",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Barbed Skewer\"}"},AttributeModifiers:[{UUIDMost:-7843367329849848096L,UUIDLeast:-9169945198809240001L,Amount:15.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:fishing_rod",Count:1b,tag:{display:{Name:"{\"text\":\"§aMermaid\\u0027s Touch\"}"}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:guardian',
            'CustomName': r'''Debuff Phaser'''
        },
        'mojangson': r'''{id:"minecraft:guardian",CustomName:"[{\"text\":\"Debuff Phaser\"}]",Passengers:[{CustomName:"[{\"text\":\"Ocean\\u0027s Antidote\"}]",Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:3b,Amplifier:9b}],Potion:"minecraft:empty",display:{Name:"[{\"text\":\"Ocean\\u0027s Blessing\",\"italic\":false}]"}}},id:"minecraft:potion"}],Health:68.0f,Attributes:[{Base:10.0d,Name:"generic.attackDamage"},{Base:68.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"}],Silent:1b,Tags:["boss_debuffhit","Elite"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:spider',
            'CustomName': r'''Rageroot Arachnid'''
        },
        'mojangson': r'''{id:"minecraft:spider",CustomName:"[{\"text\":\"Rageroot Arachnid\",\"color\":\"gold\"}]",Health:180.0f,Attributes:[{Base:180.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:0.3d,Name:"generic.movementSpeed"}],PersistenceRequired:0b,Tags:["Elite"],HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Sharpened Fangs\"}"},AttributeModifiers:[{UUIDMost:-558721672100425944L,UUIDLeast:-8124267424213379293L,Amount:16.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:creeper',
            'CustomName': r'''Rageroot Creeper'''
        },
        'mojangson': r'''{id:"minecraft:creeper",Fuse:15s,CustomName:"[{\"text\":\"Rageroot Creeper\",\"color\":\"gold\"}]",Health:90.0f,Attributes:[{Base:90.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"}],PersistenceRequired:0b,ExplosionRadius:6b,Tags:["Elite","boss_volatile"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:ocelot',
        ...
        'mojangson': r'''{id:"minecraft:ocelot",AgeLocked:1b,CustomName:"[{\"text\":\"Rabid Ocelot\"}]",Health:45.0f,Attributes:[{Base:45.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:0.2d,Name:"generic.movementSpeed"}],Tags:["boss_targetplayer"],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Fangs\"}"},AttributeModifiers:[{UUIDMost:-8960180552131130808L,UUIDLeast:-5455308468062322858L,Amount:5.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
            'CustomName': r'''Camouflaged Swarmer'''
        },
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Camouflaged Swarmer\"}]",IsBaby:1b,Health:45.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:8737041,Name:"{\"text\":\"§fLeafweave Sandals\"}"},AttributeModifiers:[{UUIDMost:-382133999706684619L,UUIDLeast:-6317337915334863574L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:8737041,Name:"{\"text\":\"§fLeafweave Trousers\"}"},AttributeModifiers:[{UUIDMost:859917323600545817L,UUIDLeast:-8778870212998811052L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:chainmail_chestplate",Count:1b,tag:{display:{Name:"{\"text\":\"§2§lLeafveil Shroud\"}"},AttributeModifiers:[{UUIDMost:8219733933951370485L,UUIDLeast:-5084087028162377544L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:jungle_leaves",Count:1b}],Attributes:[{Base:45.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"},{Base:0.21d,Name:"generic.movementSpeed"}],HandItems:[{id:"minecraft:wooden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§fLiving Thorn\"}"},AttributeModifiers:[{UUIDMost:-3881071891453163442L,UUIDLeast:-4702150977003512039L,Amount:12.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
    ...
    },
    {
        'rules': {
            ...
            'CustomName': r'''Unyielding Silverfish'''
        },
        'mojangson': r'''{id:"minecraft:silverfish",CustomName:"[{\"text\":\"Unyielding Silverfish\"}]",Health:54.0f,Attributes:[{Base:54.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:128.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Grave Nibble\"}"},AttributeModifiers:[{UUIDMost:521411499802511775L,UUIDLeast:-7101535124109311188L,Amount:7.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:phantom',
            'CustomName': r'''Bloated Phantom'''
        },
        'mojangson': r'''{id:"minecraft:phantom",CustomName:"[{\"text\":\"Bloated Phantom\"}]",Health:27.0f,Size:2,Attributes:[{Base:27.0d,Name:"generic.maxHealth"},{Base:128.0d,Name:"generic.followRange"}],HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"[{\"text\":\"Swift Bite\",\"italic\":false}]"},AttributeModifiers:[{UUIDMost:7760838378018586847L,UUIDLeast:-6265449433678749048L,Amount:2.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    # Fred Mobs
    ################################################################################
]
