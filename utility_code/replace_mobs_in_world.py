...
mobs_to_replace = [
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:wither_skeleton",HurtByTimestamp:0,Leashed:0b,Health:100.0f,Bukkit.updateLevel:2,Attributes:[{Base:0.25d,Name:"generic.movementSpeed"},{Base:0.5d,Name:"generic.knockbackResistance"},{Base:24.0d,Name:"generic.followRange"},{Base:100.0d,Name:"generic.maxHealth"}],LeftHanded:1b,OnGround:1b,Dimension:0,PortalCooldown:0,AbsorptionAmount:0.0f,HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Dual Frost Greatsword\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"}],AttributeModifiers:[{UUIDMost:-8384178093876229456L,UUIDLeast:-6391293834308343154L,Amount:15.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Dual Frost Greatsword\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"}],AttributeModifiers:[{UUIDMost:-8384178093876229456L,UUIDLeast:-6391293834308343154L,Amount:15.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}}],CustomName:"[{\"text\":\"Frost Moon Brute\",\"color\":\"gold\"}]",WorldUUIDMost:-1041596277173696703L,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},AttributeModifiers:[{UUIDMost:31492316112044816L,UUIDLeast:-8556528064959196441L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},AttributeModifiers:[{UUIDMost:2502059920319923451L,UUIDLeast:-7340807275252271259L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},AttributeModifiers:[{UUIDMost:7253508311050896534L,UUIDLeast:-8328577651339812818L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],PersistenceRequired:1b,Team:"mobs",Spigot.ticksLived:381,Tags:["Elite","boss_charger"],WorldUUIDLeast:-7560693509725274339L}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
    ...
    # Light Gray Mobs
    {
        ...
        'mojangson': r'''{id:"minecraft:vindicator",CustomName:"[{\"text\":\"Alutana\\u0027s Devoted\"}]",Health:50.0f,Attributes:[{Base:50.0d,Name:"generic.maxHealth"},{Base:0.35d,Name:"generic.movementSpeed"}],Team:"mobs",HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{display:{Name:"{\"text\":\"§6§lQuerter\\u0027s Hatchet\"}"},AttributeModifiers:[{UUIDMost:-6854216625839389042L,UUIDLeast:-5746908136694100016L,Amount:10.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:spider',
        ...
        'mojangson': r'''{id:"minecraft:spider",CustomName:"[{\"text\":\"Wolf Spider\"}]",Health:40.0f,Attributes:[{Base:0.25d,Name:"generic.movementSpeed"},{Base:40.0d,Name:"generic.maxHealth"}],Team:"mobs",HandItems:[{id:"minecraft:bone",Count:1b,tag:{display:{Name:"{\"italic\":false,\"text\":\"Crushing Bite\"}"},AttributeModifiers:[{UUIDMost:-3564283386566917213L,UUIDLeast:-8614227812141559677L,Amount:13.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:stray',
        ...
        'mojangson': r'''{id:"minecraft:stray",CustomName:"[{\"text\":\"Follower of Alutana\"}]",Health:25.0f,Attributes:[{Base:0.3d,Name:"generic.movementSpeed"},{Base:25.0d,Name:"generic.maxHealth"}],Team:"mobs",HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§fStorm Dagger\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-9012139191445993181L,UUIDLeast:-7426312281344377946L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:drowned',
        ...
        'mojangson': r'''{id:"minecraft:drowned",CustomName:"[{\"text\":\"Frost Moon Retiarius\"}]",Health:45.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.B\"}"},AttributeModifiers:[{UUIDMost:31492316112044816L,UUIDLeast:-8556528064959196441L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.L\"}"},AttributeModifiers:[{UUIDMost:2502059920319923451L,UUIDLeast:-7340807275252271259L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:60395,Name:"{\"text\":\"F.C\"}"},AttributeModifiers:[{UUIDMost:7253508311050896534L,UUIDLeast:-8328577651339812818L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"0c3eedc4-a350-439c-8489-af2a768bdc41",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjE2ZjdkYjY3YTcyM2Q1YzMwYmY5ZDQ3ZWQ2YzI4YmY3ZDQzNmQ4ODZlMGYzNTk1MTAzMzY4MTk5ZTNhMTliYiJ9fX0="}]}}}}],Attributes:[{Base:0.3d,Name:"generic.movementSpeed"},{Base:45.0d,Name:"generic.maxHealth"}],Team:"mobs",Tags:["boss_frostnova"],HandItems:[{id:"minecraft:trident",Count:1b,tag:{Damage:0}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:creeper',
        ...
        'mojangson': r'''{id:"minecraft:creeper",Fuse:40s,powered:1b,CustomName:"[{\"text\":\"Creeping Frost\"}]",Passengers:[{CustomName:"[{\"text\":\"Frostbite\"}]",Potion:{id:"minecraft:splash_potion",Count:1b,tag:{CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:200,Id:2b,Amplifier:4b}],Potion:"minecraft:empty"}},id:"minecraft:potion"}],Health:40.0f,Attributes:[{Base:0.2d,Name:"generic.movementSpeed"},{Base:40.0d,Name:"generic.maxHealth"}],Team:"mobs",ExplosionRadius:3b,Tags:["boss_invisible"]}''',
    },
    {
        'rules': {
        ...
        'mojangson': r'''{id:"minecraft:illusioner",CustomName:"[{\"text\":\"Shadow Magician\",\"color\":\"gold\"}]",Health:75.0f,Attributes:[{Base:0.25d,Name:"generic.movementSpeed"},{Base:32.0d,Name:"generic.followRange"},{Base:75.0d,Name:"generic.maxHealth"}],Team:"mobs",PersistenceRequired:1b,Tags:["Elite"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:"{\"text\":\"§9§lArcane Hailstorm\"}"},Enchantments:[{lvl:10s,id:"minecraft:power"}],Damage:0}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:wither_skeleton',
        ...
        'mojangson': r'''{id:"minecraft:wither_skeleton",CustomName:"[{\"text\":\"Abyss Walker\",\"color\":\"gold\",\"italic\":false}]",Health:100.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:13684991,Name:"{\"text\":\"§b§lZephyric Sandals\"}"},Damage:0,AttributeModifiers:[{UUIDMost:1524986185550087386L,UUIDLeast:-8300379990213781763L,Amount:0.0d,Slot:"feet",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:6299664,Name:"{\"text\":\"§4§lAncient Robes\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-6403310306428762962L,UUIDLeast:-8965169563547431230L,Amount:0.0d,Slot:"legs",AttributeName:"generic.armor",Operation:0,Name:"Modifier"}]}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:41215,Name:"{\"text\":\"§6§lC\\u0027Zanil\\u0027s Shroud\"}"},Enchantments:[{lvl:6s,id:"minecraft:projectile_protection"}],AttributeModifiers:[{UUIDMost:-3958427209857416958L,UUIDLeast:-7375569221386509883L,Amount:0.0d,Slot:"chest",AttributeName:"generic.armor",Operation:1,Name:"Modifier"}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"251ab4e3-c5f6-61e5-b664-59f78f131844",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWJlZGI4ZDRiMDZlZWI5NzllZTUxNWY3NzhmMzFiM2RlZWY5MmZiNTgxN2YzNDUyZjUxZmM1OGQ0ODEzNCJ9fX0="}]}},display:{Name:"{\"text\":\"§3§lPhantom\\u0027s Hood\"}"}}}],Attributes:[{Base:64.0d,Name:"generic.followRange"},{Base:0.275d,Name:"generic.movementSpeed"},{Base:100.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"}],Team:"mobs",PersistenceRequired:1b,Tags:["Elite","boss_icebreak"],HandItems:[{id:"minecraft:iron_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§c§lWilt\"}"},Damage:0,AttributeModifiers:[{UUIDMost:-1568000193023031844L,UUIDLeast:-5645720831671805974L,Amount:17.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{id:"minecraft:stone_sword",Count:1b,tag:{RepairCost:1,display:{Name:"{\"text\":\"§8§lNight\\u0027s Shadow\"}"}}}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
    ...
    },
    {
        ...
        'mojangson': r'''{id:"minecraft:iron_golem",CustomName:"[{\"text\":\"Frost Golem\",\"color\":\"gold\",\"italic\":false}]",Health:200.0f,Attributes:[{Base:1.0d,Name:"generic.knockbackResistance"},{Base:200.0d,Name:"generic.maxHealth"},{Base:0.15d,Name:"generic.movementSpeed"},{Base:0.0d,Name:"generic.attackDamage"}],Team:"mobs",PersistenceRequired:1b,AttackTime:1s,Tags:["Elite","boss_iceaspect","boss_targetplayer"],HandItems:[{id:"minecraft:poppy",Count:1b,tag:{HideFlags:0,display:{Name:"{\"italic\":false,\"text\":\"Frost Covenant\"}"}}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
