...
mobs_to_replace = [
    ...
    },
    {
        'rules': {
            ...
            'CustomName': r'''Barista'''
        },
        'mojangson': r'''{id:"minecraft:villager",AgeLocked:0b,Attributes:[{Base:20.0d,Name:"generic.maxHealth"},{Base:1.0d,Name:"generic.knockbackResistance"},{Base:0.0d,Name:"generic.movementSpeed"},{Base:0.0d,Name:"generic.armor"},{Base:0.0d,Name:"generic.armorToughness"},{Base:16.0d,Name:"generic.followRange"}],Riches:0,Invulnerable:0b,ForcedAge:0,AbsorptionAmount:0.0f,PersistenceRequired:1b,Age:0,Motion:[0.0d,-0.0784000015258789d,0.0d],Health:20.0f,LeftHanded:0b,Paper.SpawnReason:"DEFAULT",Offers:{Recipes:[{maxUses:2147483647,buy:{id:"minecraft:experience_bottle",Count:32b},sell:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:9325341,CustomPotionEffects:[{Ambient:1b,ShowParticles:1b,Duration:1800,Id:1b,Amplifier:0b},{Ambient:1b,ShowParticles:1b,Duration:200,Id:11b,Amplifier:1b}],Potion:"minecraft:empty",display:{Lore:["§8Coffee Cat Cafe's Coffee"],Name:"{\"text\":\"§fDark Roast\"}"}}},uses:0,rewardExp:1b},{maxUses:2147483647,buy:{id:"minecraft:experience_bottle",Count:48b},sell:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:11363115,CustomPotionEffects:[{Ambient:1b,ShowParticles:1b,Duration:3000,Id:1b,Amplifier:1b}],Potion:"minecraft:empty",display:{Lore:["§8Coffee Cat Cafe's Coffee"],Name:"{\"text\":\"§fLight Roast\"}"}}},uses:0,rewardExp:1b},{maxUses:2147483647,buy:{id:"minecraft:experience_bottle",Count:32b},sell:{id:"minecraft:potion",Count:1b,tag:{CustomPotionColor:16056315,CustomPotionEffects:[{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:22b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:27b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:15b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:12b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:24b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:3b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:21b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:17b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:14b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:8b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:0,Id:25b,Amplifier:29b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:26b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:4b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:9b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:16b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:19b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:10b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:11b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:23b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:2b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:1b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:5b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:13b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:18b,Amplifier:49b},{Ambient:1b,ShowIcon:1b,ShowParticles:1b,Duration:1,Id:20b,Amplifier:49b}],HideFlags:32,Potion:"minecraft:empty",display:{Lore:["§8Coffee Cat Cafe's Coffee","§7Clears all Potion Effects when consumed"],Name:"{\"text\":\"§fCream\"}"}}},uses:2,rewardExp:1b},{maxUses:2147483647,buy:{id:"minecraft:dragon_breath",Count:12b,tag:{HideFlags:1,display:{Lore:["§7Worth 8 enchanting bottles"],Name:"{\"text\":\"§6Concentrated Experience\"}"},Enchantments:[{lvl:1s,id:"minecraft:power"}]}},sell:{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"e2b8da20-96d0-400f-b948-22892c6ce88c",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTdiY2M5OWFkNjlmMjEwMWJiN2UyY2Y4MzU5NmNmNTgxNjQ0NjEwMzdkMDEzNGJmMmU5ZGQ3YjY2Yjc4In19fQ=="}]}},display:{Lore:["§8King's Valley : Tier IV"],Name:"{\"text\":\"§fCoffee Cat Cafe Plushie\"}"},Enchantments:[{lvl:3s,id:"minecraft:fire_protection"},{lvl:1s,id:"minecraft:protection"}]}},uses:0,rewardExp:1b}]},HandItems:[{},{}],Profession:4,CustomName:"{\"text\":\"Barista\"}",Fire:-1s,ArmorItems:[{},{},{},{}],CareerLevel:100001,Career:3,Inventory:[],Willing:1b}''',
    },
    {
        'rules': {
