...
mobs_to_replace = [
    ...
    },
    {
        ...
        'nbt': r'''{CustomName:"{\"text\":\"Radiant Blaze\"}",Health:30.0f,Attributes:[{Base:30.0d,Name:"generic.maxHealth"}],id:"minecraft:blaze",Tags:["boss_fireball"]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
        ...
        'nbt': r'''{CustomName:"{\"text\":\"Pyro Miner\"}",Health:40.0f,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Boots\"}"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Pants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5643800,Name:"{\"text\":\"§fInfernal Tunic\"}"}}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:3416859,Name:"{\"text\":\"§fBurnt Helm\"}"}}}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],id:"minecraft:skeleton",Tags:["boss_blockbreak"],HandItems:[{id:"minecraft:iron_pickaxe",Count:1b,tag:{display:{Name:"{\"text\":\"§bBasanite Miner\\u0027s Pick\"}"},Damage:0,AttributeModifiers:[{UUIDMost:6439584543901370625L,UUIDLeast:-5460530576207987635L,Amount:9.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:zombie',
        ...
        'nbt': r'''{CustomName:"{\"text\":\"Mage Defender\"}",Health:40.0f,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,tag:{display:{Name:"{\"text\":\"§bAquamarineBoots\"}"}}},{id:"minecraft:chainmail_leggings",Count:1b,tag:{display:{Name:"{\"text\":\"§bAquamarinePants\"}"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:3287104,Name:"{\"text\":\"§1§lVoidguard\"}"}}},{}],Attributes:[{Base:40.0d,Name:"generic.maxHealth"}],id:"minecraft:zombie",HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{display:{Name:"{\"text\":\"§bArcane Deathbringer\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"}],AttributeModifiers:[{UUIDMost:6490429914453657687L,UUIDLeast:-7163478804406197079L,Amount:8.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
    ...
    },
    {
        ...
        'nbt': r'''{CustomName:"{\"text\":\"Spore Swarmer\"}",Passengers:[{Potion:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:harming"}},id:"minecraft:potion"}],IsBaby:1b,Health:10.0f,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,tag:{display:{Name:"{\"text\":\"§bSporeSwarmerBoots\"}"}}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:4673362,Name:"{\"text\":\"§bSporeSwarmerChest\"}"}}},{id:"minecraft:red_mushroom_block",Count:1b}],Attributes:[{Base:10.0d,Name:"generic.maxHealth"}],id:"minecraft:zombie",HandItems:[{id:"minecraft:brown_mushroom",Count:1b,tag:{AttributeModifiers:[{UUIDMost:3986171858156734267L,UUIDLeast:-8071532259608096167L,Amount:5.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"}]}},{}]}''',
    },
    {
        'rules': {
            'id': 'minecraft:skeleton',
    ...
    for replacement in mobs_to_replace:
        if entity.has_path('id') and entity.at_path('id').value == replacement['rules']['id']:
            ...
            if matches:
                # Replace this entity
                log_handle.write("\n")
                log_handle.write("    TO:    {}\n".format(replacement['nbt']))
                log_handle.write("    FROM:  {}\n".format(entity.to_mojangson()))
                log_handle.write("    AT:    {}\n".format(get_debug_string_from_entity_path(entity_path)))
                log_handle.write("\n")

                entity.value = nbt.TagCompound.from_mojangson(replacement['nbt']).value
