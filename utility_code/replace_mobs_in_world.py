...
mobs_to_replace = [
    ...
    # Cyan mobs
    {
        ...
        'mojangson': r'''{id:"minecraft:wither",CustomName:"{\"text\":\"§6Eldritch Demon\"}",Health:160.0f,Attributes:[{Base:160.0d,Name:"generic.maxHealth"}],DeathLootTable:"empty",Tags:["Elite"]}''',
    },
    # Cyan mobs
    ################################################################################
]
