...
for plot_id in plots:
    ...
    if facing == "north":
        plot["mailbox_items"] = get_items(world, max_x - 1, min_y + 10, max_z + 1, max_x, min_y + 18, max_z + 3)
    elif facing == "east":
        plot["mailbox_items"] = get_items(world, min_x - 2, min_y + 10, max_z - 1, min_x, min_y + 18, max_z)
    elif facing == "south":
        plot["mailbox_items"] = get_items(world, min_x + 1, min_y + 10, min_z - 2, min_x + 2, min_y + 18, min_z)
    elif facing == "west":
        plot["mailbox_items"] = get_items(world, max_x + 1, min_y + 10, min_z + 1, max_x + 3, min_y + 18, min_z + 2)
