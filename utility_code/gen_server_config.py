...
if __name__ == '__main__':
    ...
    server_config_to_copy = [
        ...
        ('plugins/MonumentaCommon/zone_config.yml', 'show_zones_dynmap', 'show_zones_dynmap: {}'.format(SERVER_TYPE == 'build')),
    ...
    monumenta = [
        ...
        ('plugins/ScriptedQuests/compass/1_{servername}', '../../../../server_config/data/scriptedquests/compass/{servername}'),
        ('plugins/ScriptedQuests/compass/0_common', '../../../../server_config/data/scriptedquests/compass/common'),
        ('plugins/ScriptedQuests/clickables/1_{servername}', '../../../../server_config/data/scriptedquests/clickables/{servername}'),
        ('plugins/ScriptedQuests/clickables/0_common', '../../../../server_config/data/scriptedquests/clickables/common'),
        ('plugins/ScriptedQuests/death/1_{servername}', '../../../../server_config/data/scriptedquests/death/{servername}'),
        ('plugins/ScriptedQuests/death/0_common', '../../../../server_config/data/scriptedquests/death/common'),
        ('plugins/ScriptedQuests/login/1_{servername}', '../../../../server_config/data/scriptedquests/login/{servername}'),
        ('plugins/ScriptedQuests/login/0_common', '../../../../server_config/data/scriptedquests/login/common'),
        ('plugins/ScriptedQuests/npcs/1_{servername}', '../../../../server_config/data/scriptedquests/npcs/{servername}'),
        ...
        ('plugins/ScriptedQuests/codes/0_common', '../../../../server_config/data/scriptedquests/codes/common'),
        ('plugins/ScriptedQuests/interactables/1_{servername}', '../../../../server_config/data/scriptedquests/interactables/{servername}'),
        ('plugins/ScriptedQuests/interactables/0_common', '../../../../server_config/data/scriptedquests/interactables/common'),
        ('plugins/ScriptedQuests/zone_namespaces/1_{servername}', '../../../../server_config/data/scriptedquests/zone_namespaces/{servername}'),
        ('plugins/ScriptedQuests/zone_namespaces/0_common', '../../../../server_config/data/scriptedquests/zone_namespaces/common'),
        ('plugins/ScriptedQuests/zone_properties/1_{servername}', '../../../../server_config/data/scriptedquests/zone_properties/{servername}'),
        ('plugins/ScriptedQuests/zone_properties/0_common', '../../../../server_config/data/scriptedquests/zone_properties/common'),
        ('plugins/ScriptedQuests/zone_property_groups/1_{servername}', '../../../../server_config/data/scriptedquests/zone_property_groups/{servername}'),
        ('plugins/ScriptedQuests/zone_property_groups/0_common', '../../../../server_config/data/scriptedquests/zone_property_groups/common'),
