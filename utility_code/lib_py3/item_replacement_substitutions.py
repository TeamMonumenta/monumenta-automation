...
class SubtituteItems(SubstitutionRule):
    ...
    def __init__(self):
        ...
        for substitution in [
            ...
            ["minecraft:leather_chestplate", "Basilisk Hide", "minecraft:leather_chestplate", "Ghoulskin Vestment"],
            ["minecraft:leather_chestplate", "Basilisk Scales", "minecraft:leather_chestplate", "Ghoulskin Shroud"],
            ["minecraft:stone_axe", "Acrid Wrath", "minecraft:stone_axe", "Searing Wrath"],
            ...
            ["minecraft:bone", "Deathchill Staff", "minecraft:bone", "Staff of the Soulseaker"],
            ...
            ["minecraft:stone_axe", "Mythril Cleaver", "minecraft:stone_axe", "Jaguartooth Cleaver"],
            ...
            ["minecraft:pink_tulip", "Teewee's Eternal Tulip", "minecraft:white_tulip", "Eternal Bloom"],
            ["minecraft:stone_axe", "Annihilator", "minecraft:stone_axe", "Lunatic's Respite"],
            ["minecraft:bow", "Xanatull's Skystorm", "minecraft:bow", "Arcane Hailstorm"],
            ...
            ["minecraft:stone_axe", "Wrath of the Mountain", "minecraft:stone_axe", "Wrath of the Mountains"],
            ...
            ["minecraft:leather_helmet", None, "minecraft:leather_helmet", "Leather Helmet"],
            ["minecraft:leather_chestplate", None, "minecraft:leather_chestplate", "Leather Chestplate"],
            ["minecraft:leather_leggings", None, "minecraft:leather_leggings", "Leather Leggings"],
