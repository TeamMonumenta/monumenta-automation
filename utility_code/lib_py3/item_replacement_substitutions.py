...
class NameUnnamedItems(SubstitutionRule):
    ...
    def _init_unnamed_items(cls):
        ...
        named_chests = (
            r'''{Items:[{Count:53b,Slot:0b,id:"minecraft:golden_apple",tag:{display:{Name:'{"extra":[{"bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"dark_red","text":"Twisted Pome"}],"text":""}'},plain:{display:{Name:"Twisted Pome"}}}}]}''',
            r'''{Items:[{Count:1b,Slot:0b,id:"minecraft:potion",tag:{CustomPotionColor:16711680,CustomPotionEffects:[{Ambient:1b,Amplifier:1b,Duration:0,Id:6b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:mundane",display:{Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"red","text":"Red Potion"}],"text":""}'},plain:{display:{Name:"Red Potion"}}}},{Count:1b,Slot:1b,id:"minecraft:potion",tag:{CustomPotionColor:1114367,CustomPotionEffects:[{Ambient:1b,Amplifier:2b,Duration:0,Id:6b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:mundane",display:{Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"blue","text":"Blue Potion"}],"text":""}'},plain:{display:{Name:"Blue Potion"}}}},{Count:1b,Slot:2b,id:"minecraft:splash_potion",tag:{Potion:"minecraft:long_water_breathing",display:{Name:'{"bold":true,"italic":false,"underlined":false,"color":"#1773b1","text":"Aqueous Vial"}'},plain:{display:{Name:"Aqueous Vial"}}}},{Count:1b,Slot:3b,id:"minecraft:potion",tag:{CustomPotionColor:49151,CustomPotionEffects:[{Ambient:1b,Amplifier:0b,Duration:4800,Id:16b,ShowIcon:1b,ShowParticles:1b},{Ambient:1b,Amplifier:0b,Duration:4800,Id:13b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:mundane",display:{Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"white","text":"Nereid Essence"}],"text":""}'},plain:{display:{Name:"Nereid Essence"}}}},{Count:1b,Slot:4b,id:"minecraft:splash_potion",tag:{AttributeModifiers:[{Amount:1.0d,AttributeName:"minecraft:generic.armor_toughness",Name:"Dummy",Operation:2,UUID:[I;425995745,1264075117,-1232017366,1430706599]}],CustomPotionColor:16756736,CustomPotionEffects:[{Ambient:1b,Amplifier:0b,Duration:200,Id:12b,ShowIcon:1b,ShowParticles:1b}],Enchantments:[{id:"minecraft:power",lvl:1s}],HideFlags:71,Potion:"minecraft:mundane",display:{Lore:[],Name:'{"bold":true,"italic":false,"underlined":false,"color":"#ffbf00","text":"Extinguisher"}'},plain:{display:{Name:"Extinguisher"}}}},{Count:1b,Slot:5b,id:"minecraft:splash_potion",tag:{Potion:"minecraft:fire_resistance",display:{Name:'{"bold":true,"italic":false,"underlined":false,"color":"#ffb43e","text":"Firecloak Vial"}'},plain:{display:{Name:"Firecloak Vial"}}}},{Count:1b,Slot:6b,id:"minecraft:potion",tag:{CustomPotionColor:16776960,CustomPotionEffects:[{Ambient:1b,Amplifier:0b,Duration:12000,Id:11b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:mundane",display:{Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"yellow","text":"Yellow Potion"}],"text":""}'},plain:{display:{Name:"Yellow Potion"}}}},{Count:1b,Slot:7b,id:"minecraft:potion",tag:{CustomPotionColor:2697513,CustomPotionEffects:[{Ambient:1b,Amplifier:0b,Duration:7200,Id:1b,ShowIcon:1b,ShowParticles:1b},{Ambient:0b,Amplifier:0b,Duration:7200,Id:3b,ShowIcon:1b,ShowParticles:1b},{Ambient:0b,Amplifier:0b,Duration:7200,Id:5b,ShowIcon:1b,ShowParticles:1b},{Ambient:1b,Amplifier:0b,Duration:7200,Id:11b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:mundane",display:{Name:'{"extra":[{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"light_purple","text":"Ragebrew"}],"text":""}'},plain:{display:{Name:"Ragebrew"}}}},{Count:1b,Slot:8b,id:"minecraft:splash_potion",tag:{Potion:"minecraft:strong_slowness",display:{Name:'{"bold":true,"italic":false,"underlined":false,"color":"#afc2e3","text":"Major Frosted Glass"}'},plain:{display:{Name:"Major Frosted Glass"}}}},{Count:1b,Slot:9b,id:"minecraft:splash_potion",tag:{CustomPotionEffects:[{Ambient:0b,Amplifier:0b,Duration:900,Id:15b,ShowIcon:1b,ShowParticles:1b},{Ambient:0b,Amplifier:3b,Duration:900,Id:17b,ShowIcon:1b,ShowParticles:1b},{Ambient:0b,Amplifier:2b,Duration:900,Id:20b,ShowIcon:1b,ShowParticles:1b}],Potion:"minecraft:strong_harming",display:{Name:'{"extra":[{"bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"white","text":"Potion of Annihilation"}],"text":""}'},plain:{display:{Name:"Potion of Annihilation"}}}}]}''',
        )
