...
class NameUnnamedItems(SubstitutionRule):
    ...
    def _init_unnamed_items(cls):
        ...
        named_chests = (
            ...
            # Loreless potions
            r'''{Items:[{Count:1b,Slot:0b,id:"minecraft:potion",tag:{CustomPotionColor:1536687,Enchantments:[{id:"minecraft:power",lvl:1s}],HideFlags:33,Monumenta:{Stock:{Effects:[{EffectDuration:10800,EffectStrength:1.0d,EffectType:"WaterBreath"}]}},Potion:"minecraft:awkward",display:{Lore:['{"text":""}','{"italic":false,"color":"gray","text":"When Consumed:"}','{"italic":false,"color":"#4AC2E5","extra":[{"italic":false,"color":"dark_gray","text":" (9:00)"}],"text":"Water Breathing"}'],Name:'{"bold":true,"italic":false,"underlined":false,"color":"#5d2d87","text":"Depth Lurker"}'},plain:{display:{Lore:["","When Consumed:","Water Breathing (9:00)"],Name:"Depth Lurker"}}}}]}''',
            r'''{Items:[{Count:1b,Slot:0b,id:"minecraft:potion",tag:{CustomPotionColor:13389173,Enchantments:[{id:"minecraft:power",lvl:1s}],HideFlags:33,Monumenta:{Location:"overworld1",Stock:{Effects:[{EffectDuration:400,EffectStrength:1.0d,EffectType:"VanillaFireRes"},{EffectDuration:400,EffectStrength:0.1d,EffectType:"Resistance"},{EffectDuration:100,EffectStrength:1.0d,EffectType:"Nausea"}]}},Potion:"minecraft:awkward",display:{Lore:['{"text":""}','{"italic":false,"color":"gray","text":"When Consumed:"}','{"italic":false,"color":"#4AC2E5","extra":[{"italic":false,"color":"dark_gray","text":" (0:20)"}],"text":"Fire Immunity"}','{"italic":false,"color":"#4AC2E5","extra":[{"italic":false,"color":"dark_gray","text":" (0:20)"}],"text":"+10% Resistance"}','{"italic":false,"color":"#D02E28","extra":[{"italic":false,"color":"dark_gray","text":" (0:05)"}],"text":"Nausea"}'],Name:'{"bold":true,"italic":false,"underlined":false,"color":"yellow","text":"Blaze\'s Whiskey"}'},plain:{display:{Lore:["","When Consumed:","Fire Immunity (0:20)","+10% Resistance (0:20)","Nausea (0:05)"],Name:"Blaze's Whiskey"}}}}]}'''
            r'''{Items:[{Count:1b,Slot:0b,id:"minecraft:potion",tag:{CustomPotionColor:9325341,Enchantments:[{id:"minecraft:power",lvl:1s}],HideFlags:33,Monumenta:{Stock:{Effects:[{EffectDuration:1200,EffectStrength:0.1d,EffectType:"damage"},{EffectDuration:1200,EffectStrength:2.0d,EffectType:"Regeneration"},{EffectDuration:600,EffectStrength:1.0d,EffectType:"Poison"},{EffectDuration:100,EffectStrength:1.0d,EffectType:"Nausea"}]}},Potion:"minecraft:awkward",display:{Lore:['{"text":""}','{"italic":false,"color":"gray","text":"When Consumed:"}','{"italic":false,"color":"#4AC2E5","extra":[{"italic":false,"color":"dark_gray","text":" (1:00)"}],"text":"+10% Strength"}','{"italic":false,"color":"#4AC2E5","extra":[{"italic":false,"color":"dark_gray","text":" (1:00)"}],"text":"Regeneration II"}','{"italic":false,"color":"#D02E28","extra":[{"italic":false,"color":"dark_gray","text":" (0:30)"}],"text":"Poison I"}','{"italic":false,"color":"#D02E28","extra":[{"italic":false,"color":"dark_gray","text":" (0:05)"}],"text":"Nausea"}'],Name:'{"bold":true,"italic":false,"underlined":false,"color":"#158315","text":"Blackroot Brew"}'},plain:{display:{Lore:["","When Consumed:","+10% Strength (1:00)","Regeneration II (1:00)","Poison I (0:30)","Nausea (0:05)"],Name:"Blackroot Brew"}}}}]}'''
        )
