...
`{cmdPrefix}prepare stage bundle --debug valley labs`'''
        ...
        for shard in shards:
            ...
            elif shard in ["white", "orange", "magenta", "lightblue", "yellow", "lime", "pink", "gray", "lightgray", "cyan", "purple", "blue", "brown", "green", "red", "black", "teal", "forum", "tutorial", "reverie", "rush", "mist", "willows", "sanctum", "shiftingcity", "labs", "depths", "remorse", "corridors", "verdant", "gallery", "portal", "ruin", "skt"]:
...
'''
        ...
        # Stop bungee
        await self.stop(["bungee", "bungee-11", "bungee-13", "bungee-14", "bungee-15"])
...
Performs the weekly update on the play server. Requires StopAndBackupAction.'''
        ...
        if min_phase <= 24:
            await self.display("Deleting 0_PREVIOUS...")
