...
Must be run before starting terrain reset on the play server'''
    ...
    async def action_prepare_stage_bundle(self, cmd, message):
        ...
        for shard in shards:
            ...
            elif shard in ["white", "orange", "magenta", "lightblue", "yellow", "lime", "pink", "gray", "lightgray", "cyan", "purple", "blue", "brown", "green", "red", "black", "tutorial", "reverie", "rush", "willows", "sanctum", "shiftingcity"]:
