...
test_item = ReplacementTest(
    ...
    item_under_test=r'''{id:"minecraft:shield",tag:{HideFlags:32,Enchantments:[{lvl:2s,id:"minecraft:unbreaking"}],display:{Lore:["§8King's Valley : Tier III"],Name:"{\"text\":\"§fHardened Shield\"}"}}}''',
    expected_result_item=r'''{id:"minecraft:shield",tag:{HideFlags:32,Enchantments:[{lvl:2s,id:"minecraft:unbreaking"}],display:{Lore:["§8King's Valley : Tier III"],Name:"{\"text\":\"§fHardened Shield\"}"}}}'''
)
test_item.test()
