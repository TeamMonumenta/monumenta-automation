...
test_item = ReplacementTest(
    ...
    item_under_test=r'''{id:"minecraft:golden_sword",tag:{Unbreakable:1b,HideFlags:2,display:{Name:"{\"text\":\"§e§l§nLight of Salvation\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"},{lvl:2s,id:"minecraft:efficiency"},{lvl:1s,id:"minecraft:fire_aspect"}],AttributeModifiers:[{UUIDMost:-8751945831914649559L,UUIDLeast:-7565408329895997931L,Amount:2.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:4598269408375358984L,UUIDLeast:-7980334193493528635L,Amount:0.0d,AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:-3549468348533027207L,UUIDLeast:-5101475887946467451L,Amount:-2.4d,Slot:"mainhand",AttributeName:"generic.attackSpeed",Operation:0,Name:"Modifier"}]}}''',
    expected_result_item=r'''{id:"minecraft:golden_sword",tag:{Unbreakable:1b,HideFlags:2,display:{Name:"{\"text\":\"§e§l§nLight of Salvation\"}"},Enchantments:[{lvl:1s,id:"minecraft:knockback"},{lvl:2s,id:"minecraft:efficiency"},{lvl:1s,id:"minecraft:fire_aspect"}],AttributeModifiers:[{UUIDMost:-8751945831914649559L,UUIDLeast:-7565408329895997931L,Amount:2.0d,Slot:"mainhand",AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:4598269408375358984L,UUIDLeast:-7980334193493528635L,Amount:0.0d,AttributeName:"generic.attackDamage",Operation:0,Name:"Modifier"},{UUIDMost:-3549468348533027207L,UUIDLeast:-5101475887946467451L,Amount:-2.4d,Slot:"mainhand",AttributeName:"generic.attackSpeed",Operation:0,Name:"Modifier"}]}}'''
)
test_item.test()
