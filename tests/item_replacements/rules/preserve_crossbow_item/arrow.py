...
test_item = ItemTest(
    test_name="Rules: Preserve Crossbow Item: Arrow",
    ...
    item_under_test=r'''{id: "minecraft:crossbow", tag: {Charged: 1b, Damage: 0, display: {Name: '{"text":"Simple Crossbow"}', Lore: ['{"text":"Replace me."}']}, ChargedProjectiles: [{id: "minecraft:arrow", Count: 1b}]}, Count: 1b}''',
