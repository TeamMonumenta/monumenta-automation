...
test_item = ItemTest(
    ...
    expected_result_item=r'''{id:"minecraft:shield",tag:{HideFlags:32,Enchantments:[{lvl:2s,id:"minecraft:unbreaking"}],display:{Lore:["§8King's Valley : Tier III"],Name:"{\"text\":\"§fHardened Shield\"}"},BlockEntityTag:{id:"minecraft:banner",Patterns:[{Pattern:"bri",Color:13}],Base:9}}}'''
)
test_item.run()
