...
test_item = ItemTest(
    ...
    item_under_test=r'''{id:"minecraft:golden_sword",tag:{display:{Lore:["§7Radiant","§7Hope","§7Festive","§8King's Valley : §4Artifact","Decorated by Combustible","§l","§7When in main hand:","§7 1.6 Attack Speed","§7 3 Attack Damage","* Soulbound to Combustible *"],Name:"\"§e§l§nLight of Salvation\""}}}''',
