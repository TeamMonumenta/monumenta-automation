...
fn update_instance_scores(scores: &mut HashMap<String, i32>, days_since_epoch: i32, start_objective: &str, max_days: i32, access_objective: &str, additional_objectives_to_reset: &[&str]) {
