...
# RUN apt-get update && \
# 	apt-get install -y --no-install-recommends bzip2 git python3 python3-yaml python3-pip python3-setuptools python3-numpy && \
# 	pip3 install wheel && \
...
COPY docker/monumenta-25.sh /
RUN chmod +x /monumenta-25.sh
